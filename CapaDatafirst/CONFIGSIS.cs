...
namespace CapaDatafirst
{
    ...
    public partial class CONFIGSIS
    {
        ...
        public Nullable<int> DiasAdelantado { get; set; }
        public Nullable<bool> FACTPTOVTA { get; set; }
        public Nullable<bool> FACTLINEA { get; set; }
        public Nullable<bool> FACTSUBEMP { get; set; }
        public Nullable<int> tiempo { get; set; }
        public string ULTIMACARGACLIENT { get; set; }
        public string ULTIMACARGAPROD { get; set; }
        public string ULTIMACARGATIPOPRE { get; set; }
    }
}
