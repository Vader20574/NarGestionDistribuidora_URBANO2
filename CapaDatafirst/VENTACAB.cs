...
namespace CapaDatafirst
{
    ...
    public partial class VENTACAB
    {
        ...
        public string NRODOC_REFACT { get; set; }
        public string TIPODOC_REFACT { get; set; }
        public Nullable<int> CDLIQUIDADOR { get; set; }
        public Nullable<int> CDREPARTIDOR { get; set; }
        public Nullable<int> CDTIPORECHAZO { get; set; }
    }
}
