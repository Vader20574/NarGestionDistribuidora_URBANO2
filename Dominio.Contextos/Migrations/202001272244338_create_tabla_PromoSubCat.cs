namespace Dominio.Contextos.Migrations
{
    ...
    public partial class create_tabla_PromoSubCat : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        CODPROMO = c.String(nullable: false, maxLength: 128),
                        CODEMPRESA = c.String(),
                        DESPROMO = c.String(),
                        PRECIO_PROMO = c.Decimal(nullable: false, precision: 12, scale: 6),
                        CODZONA = c.String(),
                        CODLINEA = c.String(),
                        CODSUBLINEA = c.String(),
                        CODPRESVTA = c.String(),
                        ...
                        XTIPOPRE = c.Boolean(nullable: false),
                        XCLIENTE = c.Boolean(nullable: false),
                    })
