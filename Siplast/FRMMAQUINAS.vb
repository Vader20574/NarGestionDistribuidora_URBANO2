...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If FLAG = 0 Then
            Conecta("SELECT CODUMED FROM MAQUINA WHERE CODUMED='" & Me.txtcodmedida.Text.Trim & "' AND CODEMPRESA='" & codempresa & "'", "VER")
            ...
            sql = "nsp_inst_MAQUINAS '" & txtcodmedida.Text & "','" & txtdesmedida.Text & "','" & codempresa & "','" & TxtFactor.Text & "'  "
        ...
        End If
        If FLAG = 1 Then
            sql = "nsp_upda_MAQUINA '" & txtcodmedida.Text & "','" & txtdesmedida.Text & "','" & codempresa & "', '" & TxtFactor.Text & "'"
            PROCESO = TmpInsertDatos(sql)
            If PROCESO = True Then
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        Dim PROCESO As Boolean
        Dim sql As String
        sql = "nsp_DELE_maquina '" & txtcodmedida.Text & "','" & codempresa & "'"
        PROCESO = TmpInsertDatos(sql)
        If PROCESO = True Then
