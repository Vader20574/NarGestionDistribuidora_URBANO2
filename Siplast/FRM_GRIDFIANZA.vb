...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "NFIANZA"
        Me.DataGridTextBoxColumn2.MappingName = "NFIANZA"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "BANCO"
        Me.DataGridTextBoxColumn3.MappingName = "BANCO"
        ...
        Me.DataGridTextBoxColumn4.HeaderText = "BENEFICIO"
        Me.DataGridTextBoxColumn4.MappingName = "BENEFICIO"
...
#End Region
    ...
    Sub pasadatos()
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_CAJA_FIANZA", codempresa, grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                ...
                vie.txt_Importe.Text = TablaVend.Rows(0)("CODMAQUINA").ToString.Trim
                ...
                vie.dtpFechaVenc.Value = TablaVend.Rows(0)("CODPRES")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("SELECT P.CODPRODUCCION,P.TURNO AS NFIANZA,P.MAQUINA AS BANCO,P.CODTURNO AS BENEFICIO  FROM CAJA_FIANZA P where P.codempresa='" & codempresa & "' ORDER BY P.CODPRODUCCION", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("SELECT P.CODPRODUCCION,P.TURNO AS NFIANZA,P.MAQUINA AS BANCO,P.CODTURNO AS BENEFICIO  FROM CAJA_FIANZA P   where (P.CODPRODUCCION like '" & Me.txtdato.Text.Trim & "%' and P.codempresa='" & codempresa & "') ORDER BY P.CODPRODUCCION ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
