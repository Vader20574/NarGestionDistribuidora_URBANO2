...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(360, 120)
        ...
        Me.TxtFactor.MaxLength = 10000
        Me.TxtFactor.Name = "TxtFactor"
        Me.TxtFactor.Size = New System.Drawing.Size(228, 21)
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If FLAG = 0 Then
            Conecta("SELECT CODUMED FROM TURNO WHERE CODUMED='" & Me.txtcodmedida.Text.Trim & "' AND CODEMPRESA='" & codempresa & "'", "VER")
            ...
            Conecta("SELECT * FROM TURNO WHERE desumed='" & Me.txtdesmedida.Text.Trim & "' AND CODEMPRESA='" & codempresa & "'", "VER")
            If ds.Tables("VER").Rows.Count > 0 Then
            ...
            sql = "nsp_inst_TURNO '" & txtcodmedida.Text & "','" & txtdesmedida.Text & "','" & codempresa & "','" & TxtFactor.Text & "'  "
        ...
        End If
        If FLAG = 1 Then
            sql = "nsp_upda_TURNO '" & txtcodmedida.Text & "','" & txtdesmedida.Text & "','" & codempresa & "', '" & TxtFactor.Text & "'"
            PROCESO = TmpInsertDatos(sql)
            If PROCESO = True Then
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        Dim PROCESO As Boolean
        Dim sql As String
        sql = "nsp_DELE_TURNO '" & txtcodmedida.Text & "','" & codempresa & "'"
        PROCESO = TmpInsertDatos(sql)
        If PROCESO = True Then
