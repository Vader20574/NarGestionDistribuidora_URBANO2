...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmgridmaquinas))
        ...
        Me.Name = "frmgridmaquinas"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Registro de Maquina"
...
#End Region
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            Cargagridmedida(Grid1, "nsp_sele_MAQUINA_REPORT '" & codempresa & "','',''")
        Else
            If Me.rbcodigo.Checked = True Then
                Cargagridmedida(Grid1, "nsp_sele_MAQUINA_REPORT '" & codempresa & "','" & Me.txtdato.Text.Trim & "',''")
            Else
                Cargagridmedida(Grid1, "nsp_sele_MAQUINA_REPORT '" & codempresa & "','','" & Me.txtdato.Text.Trim & "'")
            End If
        End If
