Public Class FrmPreplanillaDeAprobacion5
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPreplanillaDeAprobacion5))
        ...
        Me.LblMontoAprob.Location = New System.Drawing.Point(762, 338)
        ...
        Me.Label4.Location = New System.Drawing.Point(552, 342)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(890, 79)
        ...
        Me.LblPreplanilla.Location = New System.Drawing.Point(302, 10)
        ...
        Me.TxtPrePlanilla.Location = New System.Drawing.Point(428, 6)
        ...
        Me.GrpCabecera.Location = New System.Drawing.Point(24, 34)
        ...
        Me.BtnBuscPrePlanilla.Location = New System.Drawing.Point(534, 6)
        ...
        'Button1
        '
        Me.Button1.Location = New System.Drawing.Point(109, 320)
        Me.Button1.Name = "Button1"
        Me.Button1.Size = New System.Drawing.Size(389, 40)
        Me.Button1.TabIndex = 8
        Me.Button1.Text = "PROCESAR"
        Me.Button1.UseVisualStyleBackColor = True
        '
        'FrmPreplanillaDeAprobacion5
        '
        ...
        Me.Name = "FrmPreplanillaDeAprobacion5"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Preplanilla de Aprobacion  [ Nota de Credito de  Cliente]"
...
#Region "FUNCIONES"
    Private Sub FonmatoGrid()
        ...
        DataGridTableStyle1.GridColumnStyles.AddRange(New DataGridTextBoxColumn() {DataColumn1, DataColumn2, DataColumn3})
                ...
                Case Keys.Enter
                    If GridNotaCred.Focus = True Then
                        If TABLE_NTACREDSERV.Rows.Count > 0 Then
                            If GridNotaCred.CurrentCell.ColumnNumber = 2 Then
                                If GridNotaCred.CurrentRowIndex > -1 Then
                                    ...
                                    If FrmOpciones.DEVOLVER = True Then
                                        For i As Integer = 0 To TABLE_NTACREDSERV.Rows.Count - 1
                                            If TABLE_NTACREDSERV.Rows(i)("AÑO").ToString.Trim = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 0).ToString.Trim _
                                            And TABLE_NTACREDSERV.Rows(i)("MES").ToString.Trim = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 1).ToString.Trim Then
                                                ''''''''''''''''''CAMBIAR EL ESTADO DE NTA CRED
                                                Select Case FrmOpciones.Opcion
                                                    Case 1
                                                        TABLE_NTACREDSERV.Rows(i)("PROCESO") = "FALTA"
                                                    Case 2
                                                        TABLE_NTACREDSERV.Rows(i)("PROCESO") = "TERMINADO"
    ...
    Private Sub CargarGrid()
        TABLE_NTACREDSERV = TmpListarDatos("SELECT_CIERRE_MES_INVENTARIO  '" & codempresa.Trim & "'")
