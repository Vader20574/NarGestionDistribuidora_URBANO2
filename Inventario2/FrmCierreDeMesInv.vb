Public Class FrmCierreDeMesInv
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmCierreDeMesInv))
        ...
        'BtnAceptar
        '
        Me.BtnAceptar.Location = New System.Drawing.Point(473, 242)
        ...
        'Button1
        '
        Me.Button1.Location = New System.Drawing.Point(473, 314)
        ...
        Me.GrpCierre.Location = New System.Drawing.Point(10, 208)
        ...
        Me.DtAño.Location = New System.Drawing.Point(60, 173)
        Me.DtAño.Name = "DtAño"
        ...
        Me.BtnBuscar.Location = New System.Drawing.Point(151, 173)
        ...
        Me.BtnGuardar.Location = New System.Drawing.Point(314, 44)
        Me.BtnGuardar.Name = "BtnGuardar"
        Me.BtnGuardar.Size = New System.Drawing.Size(132, 26)
        ...
        Me.BtnSalir.Location = New System.Drawing.Point(314, 76)
        ...
        Me.DtFechaIni.Location = New System.Drawing.Point(170, 381)
        ...
        Me.DtFechaFin.Location = New System.Drawing.Point(170, 420)
        ...
        Me.Label32.Location = New System.Drawing.Point(122, 425)
        ...
        Me.Label35.Location = New System.Drawing.Point(118, 385)
        ...
        'Button2
        '
        Me.Button2.Location = New System.Drawing.Point(58, 24)
        Me.Button2.Name = "Button2"
        Me.Button2.Size = New System.Drawing.Size(110, 86)
        Me.Button2.TabIndex = 68
        Me.Button2.Text = "Busqueda de stock"
        ...
        Me.Name = "FrmCierreDeMesInv"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Cierre De Mes Inventario"
...
#End Region
    ...
    Private Sub BtnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGuardar.Click
        ...
        If TableCierre.Rows.Count > 0 Then
            If CAyuda.Ejecutar("SP_INSFINMESINV", codempresa, Format(CDate(DtAño.Value), "yyyy")) > 0 Then
                Limpiar()
            End If
        End If
    ...
    Private Sub INSERTCIERREALDIA(ByVal FechaCierre As Date, ByVal ALMACEN As String)
        ...
        Else
            TmpInsertDatos(" INSERT INTO TMP_KARDEX (CORREL,CODEMPRESA,CDALMA, CDG01, CDARTI, STOCKINI, STOCKREC, COMPRAS, INGAJUSTE, INGTRANSF, INGOTROS,VENTAS, SALAJUSTE, SALTRANSF, SALOTROS ) " & _
                             ...
                             " FROM RESUKDX,ARTICULO WHERE  ARTICULO.FORMU = 0  AND  RESUKDX.CODARTI=ARTICULO.CODARTI AND ARTICULO.CODLINEA IN(" & CadenaCateg & ")  AND RESUKDX.ALMACEN ='" & Trim(ALMACEN) & "'  AND FECHA='" & Format(FechaCierre, "dd/MM/yyyy") & "'")
        End If
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Dim frmgridcierreinv As New frmgridcierreinv
        frmgridcierreinv.ShowDialog()
