...
Public Class dsgridclie
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsgridclie = CType(MyBase.Clone,dsgridclie)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsgridclie"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsgridclie.xsd"
    ...
    Public Class clienteDataTable
        ...
        Public Overloads Function AddclienteRow(ByVal codigo As String, ByVal apellidop As String, ByVal razon As String, ByVal ruc As String, ByVal apellidom As String, ByVal nombre As String) As clienteRow
            Dim rowclienteRow As clienteRow = CType(Me.NewRow,clienteRow)
            rowclienteRow.ItemArray = New Object() {codigo, apellidop, razon, ruc, apellidom, nombre}
