Public Class FrmCrearPlanillaCobros2
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmCrearPlanillaCobros2))
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(110, 268)
        ...
        Me.btnreporte.Location = New System.Drawing.Point(4, 214)
        Me.btnreporte.Name = "btnreporte"
        Me.btnreporte.Size = New System.Drawing.Size(100, 30)
        ...
        Me.BTNELIMINAR.Location = New System.Drawing.Point(4, 178)
        Me.BTNELIMINAR.Name = "BTNELIMINAR"
        Me.BTNELIMINAR.Size = New System.Drawing.Size(98, 30)
        ...
        Me.Name = "FrmCrearPlanillaCobros2"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Pre Planilla de Cobros"
...
#Region "Funciones"
    ...
    Private Sub BuscarCobranzaC()
        ...
        TAB_COBRANZAC = TmpListarDatos("PLANILLA_COBRANZACselecxProc_1  '" & codempresa & "','" & txtNumPlanilla.Text.Trim & "'")
    ...
    Private Sub BuscarCobranzaD()
        TmpInsertDatos("TMP_PLANILLA_VTAXCOBRAR_NuevoProc_1  '" & codempresa & "','" & txtNumPlanilla.Text & "','" & VCorrelVta & "'")
        CargarGridDet()
        FormatoGridDet()
...
#End Region
    ...
    Private Sub btnCompensar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCompensar.Click
        ...
        If TmpInsertDatos("SP_INSPLANILLA_VTAXCOBRAR_1   '" & codempresa & "','" & txtCobrador.Text & "','" & CDMONBASE & "','" & Format(CDate(dtpFecha.Value), "dd/MM/yyyy") & "','" & CDbl(lblTotalCobrado.Text) & "','" & CDbl(lblTotalCobrado.Text) / VCambioVta & "','" & CodUsuario & "','" & VCambioVta & "','" & EstadoCobro & "','','" & VCorrelVta & "','" & txtNumPlanilla.Text & "','" & "004" & "'") = True Then
            ...
            If TmpInsertDatos("NSP_AUMENTAR_CORREL_PLANILLA   '" & NROPTOVTA & "','" & codempresa & "','05','" & txtNumPlanilla.Text & "'") = True Then
            End If
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        txtNumPlanilla.Text = TmpListarDatos("SELECT NROPREPLANILLA FROM PTOVTA  WHERE CODEMPRESA='" & codempresa & "' and NROPTOVTA ='" & NROPTOVTA & "'").Rows(0)("NROPREPLANILLA")
    ...
    Private Sub GrpCabecera_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GrpCabecera.Enter

    End Sub

    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        If TmpInsertDatos("nsp_busc_preplan   '" & codempresa & "','" & txtNumPlanilla.Text & "'") = True Then
            MsgBox("SE ANULO")
