...
Public Class FrmBuscPlanillaCobranza2
...
#Region "Funciones Form"
    ...
    Private Sub CargarGrid()
        TAB_COBRANZAC = TmpListarDatos("SP_LISTAR_PLANILLA_COBRANZAC_1  '" & codempresa & "','" & Format(CDate(DtIni.Value), "dd/MM/yyyy") & "','" & Format(CDate(DtFin.Value), "dd/MM/yyyy") & "'")
