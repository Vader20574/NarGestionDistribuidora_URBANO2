...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grid1.Size = New System.Drawing.Size(1085, 296)
        Me.grid1.TabIndex = 7
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn6, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridBoolColumn1})
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "Habitacion"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "AP"
        Me.DataGridTextBoxColumn3.MappingName = "AP"
        ...
        Me.DataGridTextBoxColumn4.HeaderText = "AM"
        Me.DataGridTextBoxColumn4.MappingName = "AM"
        ...
        Me.DataGridTextBoxColumn5.HeaderText = "NOMB"
        Me.DataGridTextBoxColumn5.MappingName = "NOMB"
        ...
        Me.ClientSize = New System.Drawing.Size(1105, 372)
        Me.Controls.Add(Me.GroupBox2)
        Me.Controls.Add(Me.grid1)
        Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle
        Me.MaximizeBox = False
        Me.MaximumSize = New System.Drawing.Size(1500, 400)
        Me.MinimizeBox = False
        Me.MinimumSize = New System.Drawing.Size(576, 400)
        Me.Name = "FRM_LISTSOL"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Consulta de Solicitud Servicio"
...
#End Region
    ...
    Sub pasadatos()
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_SOLICITUD_SERVICIO", codempresa, grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                vie.txtCodSol.Text = TablaVend.Rows(0)("CODSOL")
                vie.txtCodHab.Text = TablaVend.Rows(0)("CODHAB")
                vie.tdescripHab.Text = TablaVend.Rows(0)("DESCRIPHAB")
                vie.txtCodVend.Text = TablaVend.Rows(0)("CODVEND")
                vie.tnombvend.Text = TablaVend.Rows(0)("DESCRIPVEND")
                vie.dtpFechaReg.Value = TablaVend.Rows(0)("FECHAING")
                vie.txtHora.Text = TablaVend.Rows(0)("HORAING")
                vie.txtCodClie.Text = TablaVend.Rows(0)("CODCLIENT")
                vie.tpaterno.Text = TablaVend.Rows(0)("AP")
                vie.tmaterno.Text = TablaVend.Rows(0)("AM")
                vie.tnombre.Text = TablaVend.Rows(0)("NOMB")
                vie.txtCSeguridad.Text = TablaVend.Rows(0)("CAJASEG")
                vie.TxtCochera.Text = TablaVend.Rows(0)("COCHERA")
                vie.TxtGlosa1.Text = TablaVend.Rows(0)("GLOSA1")
                vie.TxtGlosa2.Text = TablaVend.Rows(0)("GLOSA2")
                vie.TxtImporteXdia.Text = TablaVend.Rows(0)("IMPORTEXDIA")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select CODSOL as codigo,FECHAING AS FECHA,DESCRIPHAB as descripcion,AP,AM,NOMB,estado  from SOLICITUD_SERVICIO where codempresa='" & codempresa & "'  ORDER BY CODSOL ", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select CODSOL as codigo,FECHAING AS FECHA,DESCRIPHAB as descripcion,AP,AM,NOMB,estado from SOLICITUD_SERVICIO where (CODSOL  like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ORDER BY CODSOL ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select CODSOL as codigo,FECHAING AS FECHA,DESCRIPHAB as descripcion,AP,AM,NOMB,estado from SOLICITUD_SERVICIO where (DESCRIPHAB like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ORDER BY CODSOL", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
