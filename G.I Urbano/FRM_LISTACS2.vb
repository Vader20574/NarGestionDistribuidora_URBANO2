...
#End Region
    Public vie As frm_ActuSolicitudServi2
    ...
    Sub pasadatos()
        ...
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_ACT_SOLICITUD_SERVICIO2", codempresa, grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                vie.dtpFechaSalReg.Value = TablaVend.Rows(0)("FECHASAL")
                vie.txtHoraSal.Text = TablaVend.Rows(0)("HORASAL")
                vie.txtDiasXLiquidar.Text = TablaVend.Rows(0)("DIASXLIQUI")
                vie.txtMontoXAloja.Text = TablaVend.Rows(0)("MONTOAL")
                vie.txtConsumoFriobar.Text = TablaVend.Rows(0)("CONSPRB")
                vie.txtConsumoTelef.Text = TablaVend.Rows(0)("CONSTELEF")
                vie.txtConsumoOtros.Text = TablaVend.Rows(0)("CONSOTROS")
                vie.txtConsumoTotal.Text = TablaVend.Rows(0)("TOTAL")
                vie.TxtObserv.Text = TablaVend.Rows(0)("OBSERVACION")
                Try
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select CODSOL as codigo,CONVERT(VARCHAR(50),FECHASAL,103) as fecha from ACT_SOLICITUD_SERVICIO where codempresa='" & codempresa & "' order by CODSOL ", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select CODSOL as codigo,CONVERT(VARCHAR(50),FECHASAL,103) as fecha from ACT_SOLICITUD_SERVICIO where (CODSOL  like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') order by CODSOL", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select CODSOL as codigo,CONVERT(VARCHAR(50),FECHASAL,103) as fecha from ACT_SOLICITUD_SERVICIO where (OBSERVACION like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') order by CODSOL", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
