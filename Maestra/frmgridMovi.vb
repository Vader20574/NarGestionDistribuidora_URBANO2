    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                CargagridMovi(Grid1, "Nsp_Sele_TAB_MOVI '','','" & codempresa & "'")
            Else
                CargagridMovi(Grid1, "Nsp_Sele_TAB_MOVI '','','" & codempresa & "'")
            End If
        Else
            If Me.rbcodigo.Checked = True Then
                CargagridMovi(Grid1, "Nsp_Sele_TAB_MOVI '" & Me.txtdato.Text.Trim & "','','" & codempresa & "'")
            Else
                CargagridMovi(Grid1, "Nsp_Sele_TAB_MOVI '','" & Me.txtdato.Text.Trim & "','" & codempresa & "'")
            End If
        End If
