Public Class FrmMantAccesosProceso
    ...
    Private Sub FrmMantAccesos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CAyuda.CargarDataCombo(cb_modulos, "SP_PROCESO '" & codempresa & "'", "Codigo", "Descripcion")
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        dt = CAyuda.ListarDatos("SP_BUS_accesoproc", codempresa, cmbnivel.SelectedValue, cb_modulos.SelectedValue).Tables(0)
        If dt.Rows.Count > 0 Then
            MsgBox("El acceso ya existe.", MsgBoxStyle.Information, "Aviso")
            Exit Sub
        End If

        CAyuda.Ejecutar("SP_INSERT_accesoproc", codempresa, cmbnivel.SelectedValue, cb_modulos.SelectedValue)
