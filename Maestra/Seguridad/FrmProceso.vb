...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Text = "Mantenimiento de Procesos"
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If TxtCodigo.Enabled = True Then
            CAyuda.Ejecutar("SP_PROCESOS_InsProc", codempresa, TxtCodigo.Text.Trim, TxtDescripcion.Text.Trim, TxtDescrip2.Text)
        Else
            CAyuda.Ejecutar("SP_PROCESOS_UpdProc", codempresa, TxtCodigo.Text.Trim, TxtDescripcion.Text.Trim, TxtDescrip2.Text)
        End If
    ...
    Private Sub btnbuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnbuscar.Click
        Dim FrmBusc As New FrmBusqProceso
        FrmBusc.ShowDialog()
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If MsgBox("Desea Eliminar Este Registro que Selecciono", MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, "NAR SISTEMAS S.A.C") = MsgBoxResult.Yes Then
            If TxtCodigo.Text.Trim = "" Then
                ...
                Exit Sub
            End If
            If TmpInsertDatos("DELETE FROM PROCESOS  WHERE  CODEMPRESA='" & codempresa & "'  AND  CDPROCESO='" & TxtCodigo.Text.Trim & "'") = True Then
                If TmpInsertDatos("DELETE FROM accesoproc  WHERE  CODEMPRESA='" & codempresa & "'  AND  CDPROCESO='" & TxtCodigo.Text.Trim & "'") = True Then
