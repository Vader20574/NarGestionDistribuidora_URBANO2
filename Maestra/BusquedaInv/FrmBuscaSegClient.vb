Public Class FrmBuscaSegClient
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrmBuscaSegClient"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "Consulta de Segmento de Cliente"
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                CargagridZona(grid1, "Nsp_Sele_Seg_cliente '','','" & codempresa & "'")
            Else
                CargagridZona(grid1, "Nsp_Sele_Seg_cliente '','','" & codempresa & "'")
            End If
        Else
            If Me.rbcodigo.Checked = True Then
                CargagridZona(grid1, "Nsp_Sele_Seg_cliente '" & Me.txtdato.Text.Trim & "','','" & codempresa & "'")
            Else
                CargagridZona(grid1, "Nsp_Sele_Seg_cliente '','" & Me.txtdato.Text.Trim & "','" & codempresa & "'")
            End If
        End If
