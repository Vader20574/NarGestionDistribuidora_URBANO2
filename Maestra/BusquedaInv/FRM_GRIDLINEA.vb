...
#End Region
    ...
    Sub llena()
        ...
        If Me.RadioButton1.Checked = True Then
            ...
            Conecta("Nsp_sel_linea_report '" & codempresa & "','" & Me.txtdato.Text.Trim & "',''", "llena")
        Else
            Conecta("Nsp_sel_linea_report '" & codempresa & "','','" & Me.txtdato.Text.Trim & "'", "llena")
        End If
    ...
    Private Sub grdLinea_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdLinea.DoubleClick
        ...
        Try
            ...
            VIE.cbotipoprod.SelectedValue = grdLinea.Item(grdLinea.CurrentRowIndex, 2)
            VIE.TxtCorrelat.Text = grdLinea.Item(grdLinea.CurrentRowIndex, 3)
            Me.Close()
