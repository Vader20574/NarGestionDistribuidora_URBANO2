Public Class FrmBuscClientDepend
...
#Region "Funciones"
    ...
    Private Sub CargarGridForm()
        TABLECLIENT = TmpListarDatos("SP_LISTAR_CLIENTE_DEPMAEST  '" & codempresa & "','" & CboFiltrar.SelectedIndex & "'")
...
#End Region
    ...
    Private Sub FrmBuscClientDepend_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
