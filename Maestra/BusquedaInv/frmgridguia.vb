...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmgridguia))
...
#End Region
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                CargagridGuia(Grid1, "Nsp_Sele_Guiacab '','','" & codempresa & "'")
            Else
                CargagridGuia(Grid1, "Nsp_Sele_Guiacab '','','" & codempresa & "'")
            End If
        Else
            If Me.rbcodigo.Checked = True Then
                CargagridGuia(Grid1, "Nsp_Sele_Guiacab '" & Me.txtdato.Text.Trim & "','','" & codempresa & "'")
            Else
                CargagridGuia(Grid1, "Nsp_Sele_Guiacab '','" & Me.txtdato.Text.Trim & "','" & codempresa & "'")
            End If
        End If
    ...
    Private Sub grid1_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Grid1.DoubleClick
        Dim FRM As New FRMGUIADIRECTA
        VAR1 = Grid1.Item(Grid1.CurrentRowIndex, 0)
        VAR2 = Grid1.Item(Grid1.CurrentRowIndex, 1)
        Dim obj As New FRMGUIADIRECTA
        obj.mostrar()
        Me.Close()
