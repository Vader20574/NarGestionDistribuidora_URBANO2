Public Class FrmBusquedaSubLinea
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                CargagridSubLinea(Grid1, "Nsp_Sele_SubLinea '','','" & codempresa.ToString() & "'")
            Else
                CargagridSubLinea(Grid1, "Nsp_Sele_SubLinea '','','" & codempresa.ToString() & "'")
            End If
        Else
            If Me.rbcodigo.Checked = True Then
                CargagridSubLinea(Grid1, "Nsp_Sele_SubLinea '" & Me.txtdato.Text.Trim & "','','" & codempresa.ToString() & "'")
            Else
                CargagridSubLinea(Grid1, "Nsp_Sele_SubLinea '','" & Me.txtdato.Text.Trim & "','" & codempresa.ToString() & "'")
            End If
        End If
