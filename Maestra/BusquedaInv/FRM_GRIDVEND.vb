    ...
    Sub pasadatos()
        ...
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                ...
                vie.txtctaBanca.SelectedValue = TablaVend.Rows(0)("CODZONA")
                vie.cciudad.SelectedValue = TablaVend.Rows(0)("CODCIUDAD")
                vie.TxtNropedido.Text = TablaVend.Rows(0)("NROPEDIDO").ToString.Trim
                vie.cbFuerzaVenta.SelectedValue = TablaVend.Rows(0)("COD_FV")
                vie.cbZonaVenta.SelectedValue = TablaVend.Rows(0)("COD_ZV")
                vie.txtLineaCred.Text = TablaVend.Rows(0)("LINEACRED")
                vie.ckActivar.Checked = TablaVend.Rows(0)("TIPOVEND")
                vie.CheckBox1.Checked = TablaVend.Rows(0)("ESTADO")
                vie.CboTipoComision.SelectedValue = TablaVend.Rows(0)("TIPOCOMISION")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select codvend as codigo,dsvend as banco from vendedor where codempresa='" & codempresa & "'", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,dsvend as banco from vendedor where (codvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,dsvend as banco from vendedor where (estado=0 and dsvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
