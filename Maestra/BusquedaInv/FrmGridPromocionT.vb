Public Class FrmGridPromocionT
...
#Region "Fields"
    Public vie As FrmMantenimientoPromocionesT
...
#End Region
    ...
    Sub pasadatos()
        ...
        TablaAux = CAyuda.ListarDatos("NSP_LISTAR_PROMOCIONEST", codempresa, grid1(grid1.CurrentRowIndex, 0)).Tables(0)
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                ...
                Dim TablaFuerzaVenta As New DataTable
                Conecta("Nsp_Sele_promocion_filtroT '','','" & codempresa & "'", "DTG")
        ...
        Else
            If Me.rbcodigo.Checked = True Then
                ...
                Conecta("Nsp_Sele_promocion_filtroT '" & Me.txtdato.Text.Trim & "','','" & codempresa & "'", "DTG")
                TablaFuerzaVenta = ds.Tables("DTG")
