Public Class FrmGridPromocion2
...
#End Region
    ...
    Sub pasadatos()
        ...
        TB_MAXITEM = TmpListarDatos("sp_Busp_minpres '" & codempresa & "','" & vie.txtProdVtaCod.Text.Trim & "'")


        '' txtcodpres.Text = TB_MAXITEM.Rows(0)(1).ToString
        vie.lblMinPres.Text = TB_MAXITEM.Rows(0)(2).ToString
        vie.lblMinPres2.Text = TB_MAXITEM.Rows(0)(2).ToString
        ...
        vie.dtpFecha.Value = IIf(TablaAux.Rows(0)("FEC_INI") Is DBNull.Value, Now, TablaAux.Rows(0)("FEC_INI"))
