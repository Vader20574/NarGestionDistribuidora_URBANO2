...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrmBusqModulo"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Busqueda de Modulo"
...
#Region "FUNCTION FORM"
    ...
    Private Sub CargarGrid()
        TMP_MODULO = TmpListarDatos("SELECT  * FROM MODULO WHERE CODEMPRESA='" & codempresa & "'  ORDER BY DSMODULO ASC")
...
#End Region
    ...
    Private Sub TxtDato_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtDato.TextChanged
        ...
        If Me.rbcodigo.Checked = True Then
            TMP_MODULO = CAyuda.ListarDatos("Nsp_Sele_Modulo_Filtrado", TxtDato.Text, "", codempresa.ToString()).Tables(0)
            Dg1.DataSource = TMP_MODULO
        End If
