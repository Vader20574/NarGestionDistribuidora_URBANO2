...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTextBoxColumn2.MappingName = "banco"
...
#End Region
    Public vie As frm_personal
    Public vie4 As FrmCrearPlanillaCobros
    Public vie1 As New cuota_vendedor
    ...
    Sub cargadatos()
        Call Cargagrid(grid1, "NSP_LISTAR_PERSONAL2'" & codempresa & "'")
    End Sub
    ...
    Sub pasadatos()
        ...
        vie.PictureBox1.Image = Nothing
        vie.PictureBox2.Image = Nothing
        vie.PictureBox3.Image = Nothing
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_PERSONAL2", codempresa, grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                vie.tcodigo.Text = TablaVend.Rows(0)("CODVEND")
                vie.tvendedor.Text = TablaVend.Rows(0)("DSVEND")
                vie.txtDNI.Text = TablaVend.Rows(0)("DNI")
                vie.txtTelefono.Text = TablaVend.Rows(0)("TELEFONO")
                vie.dtpFechaReg.Value = TablaVend.Rows(0)("FECHA_REF")
                vie.txtDirec.Text = TablaVend.Rows(0)("DIRECCION")
                vie.txtctaBanca.Text = TablaVend.Rows(0)("CODZONA")
                vie.cciudad.SelectedValue = TablaVend.Rows(0)("CODCIUDAD")
                vie.TxtNropedido.Text = TablaVend.Rows(0)("NROPEDIDO").ToString.Trim
                vie.txtBanca.Text = TablaVend.Rows(0)("COD_FV")
                vie.txtSueldoPlan.Text = TablaVend.Rows(0)("COD_ZV")
                vie.txtSueldo.Text = TablaVend.Rows(0)("LINEACRED")


                vie.txtTelefono2.Text = TablaVend.Rows(0)("TELEFONO2")
                vie.txtterritorio.Text = TablaVend.Rows(0)("TERRITORIO")
                vie.txtCtaContable.Text = TablaVend.Rows(0)("CTACONTABLE")

                If CAyuda.ValidaNulls(TablaVend.Rows(0)("IMAGEN_DNI")) = Nothing Then
                Else
                    vie.PictureBox1.Image = Image.FromFile(CAyuda.ValidaNulls(TablaVend.Rows(0)("IMAGEN_DNI")))
                End If

                If CAyuda.ValidaNulls(TablaVend.Rows(0)("IMAGEN_CURRICULUM")) = Nothing Then
                Else
                    vie.PictureBox2.Image = Image.FromFile(CAyuda.ValidaNulls(TablaVend.Rows(0)("IMAGEN_CURRICULUM")))
                End If

                If CAyuda.ValidaNulls(TablaVend.Rows(0)("IMAGEN_CONTRA")) = Nothing Then
                Else
                    vie.PictureBox3.Image = Image.FromFile(CAyuda.ValidaNulls(TablaVend.Rows(0)("IMAGEN_CONTRA")))
                End If

                vie.CheckBox1.Checked = TablaVend.Rows(0)("ESTADO")

                vie.dtpFechaSal.Value = TablaVend.Rows(0)("FECHA_SALIDA")
                ...
                TablaCuotasLinea = CAyuda.ListarDatos("NSP_LISTAR_PERSONAL_CONTRATO", codempresa, TablaVend.Rows(0)("CODVEND").ToString).Tables(0)
            ...
            End If
        Else
            vie1.tvendedor.Text = TablaVend.Rows(0)(2)
            vie1.TextBox1.Text = Trim(ds.Tables("pa").Rows(0)(1))
        End If
        Me.Close()
    End Sub
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select codvend as codigo,dsvend as banco from PERSONAL where codempresa='" & codempresa & "'", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,dsvend as banco from PERSONAL where (codvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,dsvend as banco from PERSONAL where ( dsvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
