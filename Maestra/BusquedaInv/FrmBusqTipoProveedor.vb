Public Class FrmBusqTipoProveedor
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                CargagridTipoProveedores(DgTipo, "Nsp_Sele_TipoProvee '','','" & codempresa & "'")
            Else
                CargagridTipoProveedores(DgTipo, "Nsp_Sele_TipoProvee '','','" & codempresa & "'")
            End If
        Else
            If Me.rbcodigo.Checked = True Then
                CargagridTipoProveedores(DgTipo, "Nsp_Sele_TipoProvee '" & Me.TxtDato.Text.Trim & "','','" & codempresa & "'")
            Else
                CargagridTipoProveedores(DgTipo, "Nsp_Sele_TipoProvee '','" & Me.TxtDato.Text.Trim & "','" & codempresa & "'")
            End If
        End If
