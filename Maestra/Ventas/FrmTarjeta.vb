...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmTarjeta))
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(372, 10)
        ...
        Me.btnreporte.Location = New System.Drawing.Point(15, 155)
        ...
        Me.BTNCERRAR.Location = New System.Drawing.Point(15, 182)
        ...
        Me.txtdes.Location = New System.Drawing.Point(80, 47)
        Me.txtdes.MaxLength = 30
        Me.txtdes.Name = "txtdes"
        Me.txtdes.Size = New System.Drawing.Size(256, 21)
        ...
        Me.crRpt.Location = New System.Drawing.Point(244, 28)
        Me.crRpt.Name = "crRpt"
        ...
        Me.ClientSize = New System.Drawing.Size(496, 230)
        ...
        Me.MaximumSize = New System.Drawing.Size(502, 262)
        Me.Name = "FrmTarjeta"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Mantenimiento de Tarjeta"
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If flag = 0 Then
            sql = "Nsp_inst_Tarjeta '" & txtcodigo.Text & "','" & txtdes.Text & "','" & CodUsuario & "'"
            PROCESO = TmpInsertDatos(sql)
            If PROCESO = True Then
                TmpInsertDatos("SP_REGISTRA_AUDITORIA '" & txtcodigo.Text.Trim & "','INSERT','TARJETA','" & Format(System.DateTime.Now, "MM/dd/yyyy hh:mm:ss tt") & "','" & CodUsuario & "','" & codempresa & "'")
            End If
        End If

        If flag = 1 Then
            sql = "Nsp_upda_Tarjeta '" & txtcodigo.Text & "','" & txtdes.Text & "','" & CodUsuario & "'"
            PROCESO = TmpInsertDatos(sql)
            If PROCESO = True Then
                TmpInsertDatos("SP_REGISTRA_AUDITORIA '" & txtcodigo.Text.Trim & "','UPDATE','TARJETA','" & Format(System.DateTime.Now, "MM/dd/yyyy hh:mm:ss tt") & "','" & CodUsuario & "','" & codempresa & "'")
            End If
        End If
    ...
    Private Sub btneliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneliminar.Click
        ...
        If MsgBox("Desea Eliminar Este Registro que Selecciono", MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, "NAR SISTEMAS S.A.C") = MsgBoxResult.Yes Then
            ...
            Dim PROCESO As Boolean
            Dim sql As String
            sql = "Nsp_delete_Tarjeta '" & txtcodigo.Text & "','" & CodUsuario & "'"
            PROCESO = TmpInsertDatos(sql)
            If PROCESO = True Then
                TmpInsertDatos("SP_REGISTRA_AUDITORIA '" & txtcodigo.Text.Trim & "','DELETE','TARJETA','" & Format(System.DateTime.Now, "MM/dd/yyyy hh:mm:ss tt") & "','" & CodUsuario & "','" & codempresa & "'")
            End If
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        Dim frmx As New FrmBuscaTarjeta
        frmx.ShowDialog()
        mostrar()
    ...
    Private Sub btnreporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreporte.Click
        'Dim frmx As New FrmVistaRTarjeta
        'frmx.ShowDialog()
        Try
            Dim dt As New DataTable
            dt = M_Cabecera_R(CodUsuario, codempresa)
            crRpt.ReportFileName = rutareporte & "RptTarjeta.rpt"
    ...
    Private Sub FrmTarjeta_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        btnnuevo.Focus()
    End Sub
