...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmRuta))
        ...
        Me.ClientSize = New System.Drawing.Size(472, 224)
        Me.ControlBox = False
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If INTFLAG_R = 0 Then
            sql = "NSP_INSERT_RUTA '" & codempresa & "','" & txtCodigo.Text & "','" & txtDescripcion.Text & "'"
        ...
        If INTFLAG_R = 1 Then
            sql = "NSP_UPDATE_RUTA '" & codempresa & "','" & txtCodigo.Text & "','" & txtDescripcion.Text & "'"
            If TmpInsertDatos(sql) = True Then
                Call BOTONES(True, False, False, False, True)
                Bloqueatextbox(Me)
                MsgBox("EL REGISTRO FUE GRABADO CORRECTAMENTE ...", MsgBoxStyle.Information, "NAR SISTEMAS S.A.C.")
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If Rpta.Equals("Yes") Then
            CAyuda.Ejecutar("NSP_DELETE_RUTA", codempresa, txtCodigo.Text.Trim)
