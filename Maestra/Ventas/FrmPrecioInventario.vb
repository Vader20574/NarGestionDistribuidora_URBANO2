...
Public Class FrmPrecioInventario
    Dim ruta As String


    Dim listaP As New List(Of Arti)
            ...
            End If
              ...
              Try
                For i As Integer = 0 To Me.listaP.Count - 1
                    ...
                    CODALMACEN = listaP.Item(i).CODALMACEN.ToString
                    PRECIO = CDbl(listaP.Item(i).PRECIO1)
                    FECHA_ING = CDate(listaP.Item(i).ULTING)
                    ...
                    Dim Sql As String
                    Sql = "SP_UPDATE_ARTIDAT_DATOS '" & CODIGO_ARTI & "','" & CODALMACEN & "','" & PRECIO & "','" & FECHA_ING & "'"
            ...
            Try
                ...
                For a As Integer = 0 To excel.Length - 1
                    ...
                    If a > 0 Then
                        ...
                        o.CODALMACEN = CodAlmacen
                        o.PRECIO1 = IIf(Decimal.TryParse(linea(2), precio) = True, precio, 0)
                        o.ULTING = CDate(linea(3))
