Public Class FrmGridPromocionSubCat
...
#Region "Fields"
    Public vie As FrmMantenimientoPromociones_SubCat
...
#End Region
    ...
    Sub pasadatos()
        ...
        TablaAux = CAyuda.ListarDatos("NSP_LISTAR_PROMOCION_SUBCAT", codempresa, grid1(grid1.CurrentRowIndex, 0)).Tables(0)
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                ...
                Dim TablaFuerzaVenta As New DataTable
                Conecta("Nsp_Sele_promocion_filtro_SUBCAT '','','" & codempresa & "'", "DTG")
        ...
        Else
            If Me.rbcodigo.Checked = True Then
                ...
                Conecta("Nsp_Sele_promocion_filtro_SUBCAT '" & Me.txtdato.Text.Trim & "','','" & codempresa & "'", "DTG")
                TablaFuerzaVenta = ds.Tables("DTG")
