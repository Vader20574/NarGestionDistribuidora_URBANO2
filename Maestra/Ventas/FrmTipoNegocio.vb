...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmTipoNegocio))
        ...
        Me.crRpt.Location = New System.Drawing.Point(412, -13)
        Me.crRpt.Name = "crRpt"
...
#End Region
    ...
    Private Sub btnbuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnbuscar.Click
        ...
        Dim FRMX As New FrmGridTipoNegocio
        FRMX.vie = Me
        'FRMX.bol = True
        FRMX.ShowDialog()
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If INTFLAG_TN = 0 Then
            sql = "NSP_INSERT_TIPONEGOCIO '" & codempresa & "','" & txtCodigo.Text & "','" & txtDescripcion.Text & "'"
        ...
        If INTFLAG_TN = 1 Then
            sql = "NSP_UPDATE_TIPONEGOCIO '" & codempresa & "','" & txtCodigo.Text & "','" & txtDescripcion.Text & "'"
            If TmpInsertDatos(sql) = True Then
                MsgBox("EL REGISTRO FUE GRABADO CORRECTAMENTE ...", MsgBoxStyle.Information, "NAR SISTEMAS S.A.C.")
    ...
    Public Function VerificarDatos() As Boolean
        ...
        If INTFLAG_TN = 0 Then
            ...
            Else
                ...
                TablaConsulta = CAyuda.ListarDatos("NSP_LISTAR_TIPONEGOCIO", codempresa, Me.txtCodigo.Text.Trim).Tables(0)
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If Rpta.Equals("Yes") Then
            CAyuda.Ejecutar("NSP_DELETE_TIPONEGOCIO", codempresa, txtCodigo.Text.Trim)
    ...
    Private Sub btnreporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreporte.Click
        Try
            ...
            crRpt.ReportFileName = rutareporte & "RptTipoNegocio.rpt"
