...
Public Class FrmMantenimientoPromociones
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents cboCentroProd As ComboBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMantenimientoPromociones))
        ...
        Me.cboCentroProd = New System.Windows.Forms.ComboBox()
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(470, 400)
        ...
        Me.GroupBox5.Controls.Add(Me.cboCentroProd)
        ...
        Me.GroupBox5.Size = New System.Drawing.Size(458, 270)
        ...
        Me.Label16.Location = New System.Drawing.Point(5, 145)
        Me.Label16.Name = "Label16"
        Me.Label16.Size = New System.Drawing.Size(116, 13)
        Me.Label16.TabIndex = 19
        Me.Label16.Text = "Centro de Produccion :"
        Me.Label16.TextAlign = System.Drawing.ContentAlignment.MiddleRight
        '
        'cboCentroProd
        '
        Me.cboCentroProd.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
        Me.cboCentroProd.Enabled = False
        Me.cboCentroProd.Location = New System.Drawing.Point(122, 141)
        Me.cboCentroProd.Name = "cboCentroProd"
        Me.cboCentroProd.Size = New System.Drawing.Size(236, 21)
        Me.cboCentroProd.TabIndex = 18
        '
        'CboZona
        '
        ...
        Me.txtStock.Location = New System.Drawing.Point(204, 402)
        ...
        Me.Label10.Location = New System.Drawing.Point(98, 408)
        ...
        Me.dgCuotaLinea.Location = New System.Drawing.Point(12, 463)
        ...
        Me.CboTipoPrecio.Location = New System.Drawing.Point(88, 434)
        ...
        Me.Label14.Location = New System.Drawing.Point(9, 436)
        ...
        Me.btnAgregarPresent.Location = New System.Drawing.Point(529, 441)
        ...
        Me.btnQuitarPrest.Location = New System.Drawing.Point(531, 483)
        ...
        Me.cbTipoPago.Location = New System.Drawing.Point(696, 441)
        ...
        Me.Label15.Location = New System.Drawing.Point(634, 444)
        ...
        Me.ChkXCliente.Location = New System.Drawing.Point(478, 270)
        Me.ChkXCliente.Name = "ChkXCliente"
        Me.ChkXCliente.Size = New System.Drawing.Size(68, 17)
        Me.ChkXCliente.TabIndex = 58
        ...
        Me.ChkXTipoPre.Location = New System.Drawing.Point(478, 247)
        Me.ChkXTipoPre.Name = "ChkXTipoPre"
        Me.ChkXTipoPre.Size = New System.Drawing.Size(90, 17)
        Me.ChkXTipoPre.TabIndex = 57
        ...
        Me.Label17.Location = New System.Drawing.Point(598, 37)
        Me.Label17.Name = "Label17"
        Me.Label17.Size = New System.Drawing.Size(65, 13)
        Me.Label17.TabIndex = 62
        Me.Label17.Text = "Ruta Excel :"
        '
        'txtruta
        '
        Me.txtruta.Enabled = False
        Me.txtruta.Location = New System.Drawing.Point(677, 33)
        ...
        'btnsele
        '
        Me.btnsele.Location = New System.Drawing.Point(867, 32)
        Me.btnsele.Name = "btnsele"
        Me.btnsele.Size = New System.Drawing.Size(43, 23)
        Me.btnsele.TabIndex = 59
        Me.btnsele.Text = "..."
        ...
        Me.Name = "FrmMantenimientoPromociones"
...
#Region "Fields"
    ...
    Dim TablaTipoPagoPromo As DataTable
...
#End Region
    ...
    Private Sub FrmMantenimientoPromociones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CAyuda.CargarDataCombo(cboCentroProd, "SelectCentroCostoPromo  ", "Id", "nombcentroprom")
    ...
    Private Sub btnBusqPromo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBusqPromo.Click
        ...
        Dim FRMX As New FrmGridPromocion
        FRMX.vie = Me
        'FRMX.bol = True
        FRMX.ShowDialog()
        ...
        TablaTipoPagoPromo = CAyuda.ListarDatos("NSP_LISTAR_TipoPagoXPromocion", txtCodPromo.Text).Tables(0)
        If Me.TablaTipoPagoPromo.Rows.Count > 0 Then
            Me.DataGrid1.DataSource = TablaTipoPagoPromo
            FORMATO_GRID2()
        End If

        TablaClienteXPromo = CAyuda.ListarDatos("NSP_LISTAR_CLIENTEXPROMO", txtCodPromo.Text).Tables(0)
        ...
        If INTFLAG_R = 1 Then
            ...
            If TmpInsertDatos(sql) = True Then
                ...
                If txtruta.Text.Trim.ToString.Length > 0 Then
                    sql = "SP_DELETE_CLIENTEXPROMO '" & txtCodPromo.Text & "'"
                    If TmpInsertDatos(sql) = True Then
                    End If
                    CargarExcel2(txtruta.Text, "clientexpromo")
                End If
        ...
        Try
            ...
            If ds.Rows.Count > 0 Then
                For Each dt As DataRow In ds.Rows
                    ...
                    End If
                    cn2.Open()
                    Dim cmd2 As New SqlCommand("SP_INS_CLIENTEXPROMO", cn2)
                    ...
                    cmd2.Parameters.AddWithValue("@CODARTI_VTA", CStr(txtProdVtaCod.Text)).SqlDbType = SqlDbType.VarChar
...
#End Region
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If Rpta.Equals("Yes") Then
            CAyuda.Ejecutar("NSP_DELETE_PROMOCIONES", codempresa.Trim, txtCodPromo.Text.Trim)
    ...
    Private Sub btnAgregarPresent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarPresent.Click
        ...
        If Me.txtProdPromoCod.Text.Trim.Length > 0 Then
            CAyuda.Ejecutar("NSP_INSERT_TipoPrecioXPromocion", codempresa, txtProdVtaCod.Text.Trim, CboTipoPrecio.SelectedValue, CboTipoPrecio.Text, txtCodPromo.Text)
            TablaTipoPrecioPromo = CAyuda.ListarDatos("NSP_LISTAR_TipoPrecioXPromocion", codempresa, txtProdVtaCod.Text.Trim, txtCodPromo.Text).Tables(0)
            If Me.TablaTipoPrecioPromo.Rows.Count > 0 Then
                Me.dgCuotaLinea.DataSource = TablaTipoPrecioPromo
                FORMATO_GRID()
    ...
    Private Sub btnQuitarTipoPag_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuitarTipoPag.Click
        ...
        If txtCodPromo.Text.Trim = "" Then
            ...
            Exit Sub
        End If
        If TablaTipoPagoPromo.Rows.Count = 0 Then
            Exit Sub
        End If
        Dim Rpta As String
