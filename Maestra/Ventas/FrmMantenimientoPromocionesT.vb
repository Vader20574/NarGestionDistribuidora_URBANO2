Public Class FrmMantenimientoPromocionesT
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMantenimientoPromocionesT))
        ...
        Me.CboTipoPrecio.Location = New System.Drawing.Point(88, 420)
        ...
        Me.Label14.Location = New System.Drawing.Point(9, 422)
        ...
        '
        'FrmMantenimientoPromocionesT
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(1292, 757)
        ...
        Me.Name = "FrmMantenimientoPromocionesT"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Promociones Tienda"
...
#End Region
    ...
    Private Sub btnBusqPromo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBusqPromo.Click
        ...
        Dim FRMX As New FrmGridPromocionT
        FRMX.vie = Me
        'FRMX.bol = True
        FRMX.ShowDialog()
        ...
        TablaTipoPrecioPromo = CAyuda.ListarDatos("NSP_LISTAR_TipoPrecioXPromocionT", codempresa, txtProdVtaCod.Text.Trim, txtCodPromo.Text).Tables(0)
        If Me.TablaTipoPrecioPromo.Rows.Count > 0 Then
            Me.dgCuotaLinea.DataSource = TablaTipoPrecioPromo
            FORMATO_GRID()
        End If
        ...
        TablaTipoPagoPromo = CAyuda.ListarDatos("NSP_LISTAR_TipoPagoXPromocionT", txtCodPromo.Text).Tables(0)
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If INTFLAG_R = 1 Then
            sql = "NSP_UPDATE_PROMOCIONEST '" & codempresa & "','" & txtCodPromo.Text & "','" & txtDescripción.Text & "'," & Me.txtPrecio.Text & ",'" & Me.txtProdVtaCod.Text.Trim & "','" & CboPresentVta.SelectedValue & "'," & Me.txtProdVtaCant.Text & ",'" & Me.txtProdPromoCod.Text.Trim & "','" & CboPresentProm.SelectedValue & "'," & Me.txtProfPromoCant.Text.Trim & ", " & Me.txtStock.Text & ", '" & Me.dtpFechaIni.Value.ToShortDateString & "', '" & dtpFechaFin.Value.ToShortDateString & "' ,'" & CboZona.SelectedValue & "'," & activado & ",'" & cbTipoPago.SelectedValue.ToString & "'"
            If TmpInsertDatos(sql) = True Then
                MsgBox("EL REGISTRO FUE GRABADO CORRECTAMENTE ...", MsgBoxStyle.Information, "NAR SISTEMAS S.A.C.")
...
#End Region
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If Rpta.Equals("Yes") Then
            CAyuda.Ejecutar("NSP_DELETE_PROMOCIONEST", codempresa.Trim, txtCodPromo.Text.Trim)
    ...
    Private Sub btnAgregarPresent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarPresent.Click
        ...
        If Me.txtProdPromoCod.Text.Trim.Length > 0 Then
            CAyuda.Ejecutar("NSP_INSERT_TipoPrecioXPromocionT", codempresa, txtProdVtaCod.Text.Trim, CboTipoPrecio.SelectedValue, CboTipoPrecio.Text, txtCodPromo.Text)
            TablaTipoPrecioPromo = CAyuda.ListarDatos("NSP_LISTAR_TipoPrecioXPromocionT", codempresa, txtProdVtaCod.Text.Trim, txtCodPromo.Text).Tables(0)
            If Me.TablaTipoPrecioPromo.Rows.Count > 0 Then
                Me.dgCuotaLinea.DataSource = TablaTipoPrecioPromo
                FORMATO_GRID()
    ...
    Private Sub btnQuitarPrest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuitarPrest.Click
        ...
        If Rpta.Equals("Yes") Then
            CAyuda.Ejecutar("NSP_DELETE_TipoPrecioXPromocionT", codempresa, txtProdVtaCod.Text.Trim.Trim, Me.dgCuotaLinea(Me.dgCuotaLinea.CurrentRowIndex, 0).ToString.Trim, txtCodPromo.Text)
    ...
    Private Sub btnAgregarTipoPag_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregarTipoPag.Click
        ...
        If Me.txtProdPromoCod.Text.Trim.Length > 0 Then
            CAyuda.Ejecutar("NSP_INSERT_TipoPagoXPromocionT", txtCodPromo.Text, cbTipoPago.SelectedValue)
            TablaTipoPagoPromo = CAyuda.ListarDatos("NSP_LISTAR_TipoPagoXPromocionT", txtCodPromo.Text).Tables(0)
            If Me.TablaTipoPagoPromo.Rows.Count > 0 Then
                Me.DataGrid1.DataSource = TablaTipoPagoPromo
                FORMATO_GRID2()
