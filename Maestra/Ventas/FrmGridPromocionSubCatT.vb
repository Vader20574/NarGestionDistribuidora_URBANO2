Public Class FrmGridPromocionSubCatT
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TablaEstiloPromocion.MappingName = ""
...
#Region "Fields"
    Public vie As FrmMantenimientoPromociones_SubCatT
...
#End Region
    ...
    Sub pasadatos()
        ...
        TablaAux = CAyuda.ListarDatos("NSP_LISTAR_PROMOCION_SUBCATT", codempresa, grid1(grid1.CurrentRowIndex, 0)).Tables(0)
        ...
        vie.cbolinea.SelectedValue = TablaAux.Rows(0)("CODLINEA")

        vie.ChkActivar.Checked = CBool(TablaAux.Rows(0)("CODARTI_PROMO").ToString)

        vie.cbTipoPago.SelectedValue = TablaAux.Rows(0)("TIPO_PAGO")

        Dim TABLE_SUBCAT As DataTable
        TABLE_SUBCAT = TmpListarDatos("SP_SELECT_SUBLINEAxLINEA '" & codempresa.Trim & "' ,'" & TablaAux.Rows(0)("CODLINEA").ToString & "'")
        If TABLE_SUBCAT.Rows.Count > 0 Then
            vie.cbosublinea.DataSource = TABLE_SUBCAT
            vie.cbosublinea.ValueMember = "CODSUBLINEA"
            vie.cbosublinea.DisplayMember = "DESSUBLINEA"
        End If




        vie.cbosublinea.SelectedValue = TablaAux.Rows(0)("CODSUBLINEA")
        ...
        vie.CboPresentVta.DataSource = TmpListarDatos("SelectPRECIART_PresentxprocSUBCAT '" & codempresa & "','" & vie.cbolinea.SelectedValue.ToString & "','" & vie.cbosublinea.SelectedValue.ToString & "'")
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            If Me.rbcodigo.Checked = True Then
                ...
                Dim TablaFuerzaVenta As New DataTable
                Conecta("Nsp_Sele_promocion_filtro_SUBCATT '','','" & codempresa & "'", "DTG")
        ...
        Else
            If Me.rbcodigo.Checked = True Then
                ...
                Conecta("Nsp_Sele_promocion_filtro_SUBCATT '" & Me.txtdato.Text.Trim & "','','" & codempresa & "'", "DTG")
                TablaFuerzaVenta = ds.Tables("DTG")
