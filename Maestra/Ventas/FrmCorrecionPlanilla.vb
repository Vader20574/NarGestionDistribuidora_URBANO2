Public Class FrmCorrecionPlanilla
    ...
    Private Sub txtNroPlanilla_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNroPlanilla.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            TAB_COBRANZAC = TmpListarDatos("PLANILLA_COBRANZACselecxProc2  '" & codempresa & "','" & txtNroPlanilla.Text.Trim & "','" & ComboBox1.SelectedValue & "'")

            If TAB_COBRANZAC.Rows.Count > 0 Then
                cbProvee.SelectedValue = TAB_COBRANZAC.Rows(0)("CDCOBRADOR")
                dtpinicio.Value = Format(CDate(TAB_COBRANZAC.Rows(0)("FECHA")), "dd/MM/yyyy")
    ...
    Private Sub FrmCorrecionPlanilla_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CAyuda.CargarDataCombo(cbProvee, "SP_Listcobrador  '" & codempresa & "'", "Código", "Descripción")
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        RptaTrans = CAyuda.Ejecutar("SP_UPD_PLANILLA_COBRANZAC", codempresa, txtNroPlanilla.Text, ComboBox1.SelectedValue, dtpinicio.Value.ToShortDateString, cbProvee.SelectedValue)
