...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmProveedor))
        ...
        Me.BTNCERRAR.Location = New System.Drawing.Point(8, 157)
        ...
        Me.btncancelar.Location = New System.Drawing.Point(8, 129)
        ...
        Me.btnreporte.Location = New System.Drawing.Point(8, 185)
        ...
        Me.btnEliminar.Location = New System.Drawing.Point(8, 101)
...
#End Region
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        Dim ConsProv As New FrmConsProv
        ConsProv.ObjProv = Me
        ConsProv.ShowDialog()
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If Trim(cbFormaPago.Text) = "" Then
            MessageBox.Show("¿ INGRESE LA FORMA DE PAGO ?", "INFORMACION", MessageBoxButtons.OK, MessageBoxIcon.Question)
            cbFormaPago.Focus()
            Exit Sub
        End If

        If Trim(CboTipoProv.Text) = "" Then
            MessageBox.Show("¿ INGRESE TIPO PROVEEDOR ?", "INFORMACION", MessageBoxButtons.OK, MessageBoxIcon.Question)
            CboTipoProv.Focus()
            Exit Sub
        End If
        ...
        AIntvalor = CAyuda.ListarDatos("NSP_Select_VerficaProveedor", TxtCodProv.Text, TxtRuc.Text.Trim, codempresa).Tables(0).Rows.Count
        If pb_agregar = True Then
            ...
            Else
                ...
                SQL = "NSP_ins_PROVEEDOR '" & txtobs.Text & "','" & txtcelconta.Text & "','" & txttelconta.Text & "','" & txtdirconta.Text & _
        ...
        Else
            Dim SQL As String
            SQL = "NSP_upd_PROVEEDOR '" & txtobs.Text & "','" & txtcelconta.Text & "','" & txttelconta.Text & "','" & txtdirconta.Text & _
