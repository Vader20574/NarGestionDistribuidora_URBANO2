Public Class FrmMantTipoComisiones
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmMantTipoComisiones))
        ...
        Me.Name = "FrmMantTipoComisiones"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Mantenimiento Tipo de Comisiones"
...
#End Region
    ...
    Private Sub BtnBuscTipo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBuscTipo.Click
        Dim FrmTip As New FrmBusqTipoComisiones
        FrmTip.ShowDialog()
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If Agregar = True Then
            ...
            If TmpListarDatos("SELECT * FROM TIPOCOMISION WHERE CODEMPRESA='" & codempresa & "' AND CDTIPOCOM='" & TxtCodigo.Text.Trim & "' ").Rows.Count > 0 Then
                MsgBox("EL CODIGO YA EXISTE EN LOS REGISTROS...", MsgBoxStyle.Exclamation, "NAR SISTEMAS S.A.C.")
                Exit Sub
            End If

            If TmpListarDatos("SELECT * FROM TIPOCOMISION WHERE CODEMPRESA='" & codempresa & "' AND DSTIPOCOM='" & TxtDescripcion.Text.Trim & "' ").Rows.Count > 0 Then
                MsgBox("LA DESCRIPCION YA EXISTE EN LOS REGISTROS...", MsgBoxStyle.Exclamation, "NAR SISTEMAS S.A.C.")
                Exit Sub
            End If

            If CAyuda.Ejecutar("InsTIPOCOMISIONxProc", codempresa, TxtCodigo.Text.Trim, TxtDescripcion.Text.Trim) > 0 Then
                MsgBox("SE GUARDO CORRECTAMENTE EL REGISTRO...", MsgBoxStyle.Information, "")
                LimpiarDatos()
            End If
        Else

            If TmpListarDatos("SELECT * FROM TIPOCOMISION WHERE CODEMPRESA='" & codempresa & "' AND DSTIPOCOM='" & TxtDescripcion.Text.Trim & "' AND CDTIPOCOM <> '" & TxtCodigo.Text.Trim & "'").Rows.Count > 0 Then
                MsgBox("LA DESCRIPCION YA EXISTE EN LOS REGISTROS...", MsgBoxStyle.Exclamation, "NAR SISTEMAS S.A.C.")
                Exit Sub
            End If

            If CAyuda.Ejecutar("UpdateTIPOCOMISIONxProc", codempresa, TxtCodigo.Text.Trim, TxtDescripcion.Text.Trim) > 0 Then
                MsgBox("SE GUARDO CORRECTAMENTE EL REGISTRO...", MsgBoxStyle.Information, "")
                LimpiarDatos()
            End If
        End If
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If CAyuda.Ejecutar("EliTIPOCOMISIONxProc", codempresa, TxtCodigo.Text.Trim) > 0 Then
    ...
    Private Sub BtnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImprimir.Click
        Try
            ...
            crRpt.ReportFileName = rutareporte & "RptTipCom.rpt"
