...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Text = "Mantenimiento de Categoria de Cliente"
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If flag = 0 Then
            If CAyuda.ListarDatos("SP_VAL_CATEGORIA_CLIENTE", txtcodigo.Text.Trim, codempresa).Tables(0).Rows.Count > 0 Then
                MessageBox.Show("El código ya existe.", DesEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If

            If CAyuda.ListarDatos("SP_VAL_DESC_CATEGORIA_CLIENTE", txtdes.Text.Trim, codempresa).Tables(0).Rows.Count > 0 Then
                MessageBox.Show("La Descripcion ya existe.", DesEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If

            sql = "Nsp_inst_CATEGORIA_CLIENTE '" & txtcodigo.Text & "','" & txtdes.Text & "','" & codempresa & "'"
            PROCESO = TmpInsertDatos(sql)
        End If

        If flag = 1 Then

            If CAyuda.ListarDatos("SP_VAL_DESC_CATEGORIA_CLIENTE_UP", txtcodigo.Text, txtdes.Text.Trim, codempresa).Tables(0).Rows.Count > 0 Then
                MessageBox.Show("La Descripcion ya existe.", DesEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If

            sql = "Nsp_upda_CATEGORIA_CLIENTE '" & txtcodigo.Text & "','" & txtdes.Text & "','" & codempresa & "'"
            PROCESO = TmpInsertDatos(sql)
        End If
    ...
    Private Sub btneliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneliminar.Click
        ...
        sql = "Nsp_delete_CATEGORIA_CLIENTE '" & txtcodigo.Text & "','" & txtdes.Text & "','" & codempresa & "'"
        PROCESO = TmpInsertDatos(sql)
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        Dim frmx As New FrmBuscaCatClient
        frmx.ShowDialog()
        mostrar()
