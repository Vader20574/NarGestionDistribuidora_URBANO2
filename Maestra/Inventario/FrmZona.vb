...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmZona))
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If flag = 0 Then
            If CAyuda.ListarDatos("SP_VAL_COD_ZONA", txtcodigo.Text.Trim, codempresa).Tables(0).Rows.Count > 0 Then
                MessageBox.Show("El código ya existe.", DesEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If

            If CAyuda.ListarDatos("SP_VAL_DESC_ZONA", txtdes.Text.Trim, codempresa).Tables(0).Rows.Count > 0 Then
                MessageBox.Show("La Descripcion ya existe.", DesEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If

            sql = "Nsp_inst_Zona '" & txtcodigo.Text & "','" & txtdes.Text & "','" & CodUsuario & "','" & codempresa & "'"
            PROCESO = TmpInsertDatos(sql)
        End If

        If flag = 1 Then

            If CAyuda.ListarDatos("SP_VAL_DESC_ZONA_UP", txtcodigo.Text, txtdes.Text.Trim, codempresa).Tables(0).Rows.Count > 0 Then
                MessageBox.Show("La Descripcion ya existe.", DesEmpresa, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If

            sql = "Nsp_upda_Zona '" & txtcodigo.Text & "','" & txtdes.Text & "','" & CodUsuario & "','" & codempresa & "'"
            PROCESO = TmpInsertDatos(sql)
        End If
    ...
    Private Sub btneliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btneliminar.Click
        Dim PROCESO As Boolean
        Dim sql As String
        sql = "Nsp_delete_Zona '" & txtcodigo.Text & "','" & CodUsuario & "','" & codempresa & "'"
        PROCESO = TmpInsertDatos(sql)
