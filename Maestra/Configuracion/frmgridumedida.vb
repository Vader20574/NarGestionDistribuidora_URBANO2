...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmgridumedida))
...
#End Region
    ...
    Sub llena()
        If Me.txtdato.Text.Trim = "" Then
            Cargagridmedida(Grid1, "nsp_sele_umedida_report '" & codempresa & "','',''")
        Else
            If Me.rbcodigo.Checked = True Then
                Cargagridmedida(Grid1, "nsp_sele_umedida_report '" & codempresa & "','" & Me.txtdato.Text.Trim & "',''")
            Else
                Cargagridmedida(Grid1, "nsp_sele_umedida_report '" & codempresa & "','','" & Me.txtdato.Text.Trim & "'")
            End If
        End If
