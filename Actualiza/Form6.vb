        ...
        Try
            ...
            If ds.Rows.Count > 0 Then
                For Each dt As DataRow In ds.Rows
                    ...
                    TABLE1 = TmpListarDatos("NSP_BUSCAR_FACTURACIONP  '" & codempresa & "','" & NRODOCVAL & "','" & TIPODOCVAL & "','" & VCorrelVta & "'")
            ...
            If ds.Rows.Count > 0 Then
                For Each dt As DataRow In ds.Rows
                    ...
                    Ayuda.Ejecutar("NSP_INSERT_FILA_TMP_VENTADETGLORIA", codempresa, codArticulo, desPresentacion, DESPRES, cantidad, Precio, Precio, 0, CodUsuario, NROPTOVTA, VCorrelVta, "", 0, CDZONA, CHECKPROMO)
