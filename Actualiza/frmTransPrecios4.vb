...
Public Class frmTransPrecios4
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Try
            ...
            DataGridView1.DataSource = _
                                  GetDataExcel("C:22222\ConsolidadoBoleta2.xls", "Recuperado_Hoja1$")

            Dim dt As New DataTable
            dt = GetDataExcel("C:22222\ConsolidadoBoleta2.xls", "Recuperado_Hoja1$")




            If CAyuda.Ejecutar("SP_DELETE_ResumenBoleta", txtEjercicio.Text, cboPeriodo.Text) = 0 Then
            End If
            ...
            For x As Integer = 0 To dt.Rows.Count - 1
                ...
                If dt.Rows(x)("FECHA").ToString = "" Then
                    Exit Sub
                End If

                Dim FECHAI As Date
                FECHAI = dt.Rows(x)("FECHA").ToString


                Dim FECHAP As Date
                FECHAP = dt.Rows(x)("FECHAP").ToString


                If CAyuda.Ejecutar("INS_ResumenBoleta", Format(FECHAI, "dd/MM/yyyy"), Format(FECHAP, "dd/MM/yyyy"), dt.Rows(x)("TIPODOC").ToString, dt.Rows(x)("SERIE").ToString, dt.Rows(x)("NUMERO").ToString, dt.Rows(x)("RUC").ToString, dt.Rows(x)("RAZONSOCIAL").ToString, CDbl(dt.Rows(x)("VALORVTA").ToString), CDbl(dt.Rows(x)("IGV").ToString), CDbl(dt.Rows(x)("TOTAL").ToString), CDbl(dt.Rows(x)("AFECTO").ToString), CDbl(dt.Rows(x)("INAFECTO").ToString), CDbl(dt.Rows(x)("PERCEP").ToString), CDbl(dt.Rows(x)("TOTALCOB").ToString), dt.Rows(x)("TDOCIDEN").ToString, (dt.Rows(x)("RZ2").ToString), dt.Rows(x)("AP").ToString, (dt.Rows(x)("AM").ToString), dt.Rows(x)("NOM").ToString, 0) = 0 Then
                    MsgBox("- no se Importaron." & vbNewLine & "- Intentelo Nuevamente.", MsgBoxStyle.Information, "NARSISTEMAS")
                    Exit Sub
                End If
        ...
        MsgBox("- Ya se Importaron." & vbNewLine & "", MsgBoxStyle.Information, "NARSISTEMAS")
    ...
    Private Sub Button4_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            With AxCrystalReport1
                .ReportFileName = RutaRptInv & "Rpt_ResumenBoleta.rpt"
