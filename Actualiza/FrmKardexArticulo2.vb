Public Class FrmKardexArticulo2
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmKardexArticulo2))
        ...
        Me.Name = "FrmKardexArticulo2"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Kardex Compra Por Articulo"
...
#Region "Function Form"
    ...
    Sub ProcesarSaldo(ByVal fcierre As Date, ByVal Cierreigual As Boolean)
        ...
        TmpInsertDatos("Delete from TMp_kardexart2  WHERE CODEMPRESA='" & codempresa & "'")

        TmpInsertDatos("KARDEX_ARTICULO_REPORT_SALDO2  '" & codempresa & "','" & VCodArti & "','" & MstrFechaIni & "','" & MstrFechaFin & "','" & CDMONBASE & "','" & Trim(CboAlmacen.SelectedValue) & "','0','VENTAD','VENTAC','" & fcierre & "','0','MOVID','MOVIC'," & rand)
            ...
            For i As Integer = 0 To Meses
                ...
                TmpInsertDatos("KARDEX_ARTICULO_REPORT_SALDO_MOVI_N2  '" & codempresa & "','" & VCodArti & "','" & MstrFechaIni & "','" & MstrFechaFin & "','" & CDMONBASE & "','" & Trim(CboAlmacen.SelectedValue) & "','1','" & fcierre & "','0','" & MoviDet & "','" & MoviCab & "'," & rand)
            End If
            Next
    ...
    Sub SelectKardexart(ByVal cierrealdia As Boolean, ByVal fecha As Date)
        TmpInsertDatos("Delete from kardexdet_tmp2  WHERE  CODEMPRESA='" & codempresa & "'")
        Dim tmp_kardexArt As New DataTable
        Dim resukdx As New DataTable
        Dim saldoini As Decimal
        Dim Present As String
        tmp_kardexArt = TmpListarDatos("Select CDALMACEN,dSALMACEN,CDARTI,DSARTI,CDG01,DSG01,UNIMED,FECHA,NROMOVI,CDTIPDOC,ABRVTIPDOC,NRODOC,(COMPRAS+INGAJUSTE+INGTRANSF+INGOTROS) as CI,  (VENTAS+ SALAJUSTE + SALTRANSF + SALOTROS)as CS,SALDOFIN,CDPROVEE,COSTOBAS from tmp_kardexArt2 WHERE  CODEMPRESA='" & codempresa & "'  order by fecha,ABRVTIPDOC,nrodoc")
        ...
        If tmp_kardexArt.Rows.Count <> 0 Then
            ...
            For k As Integer = 0 To tmp_kardexArt.Rows.Count - 1
                ...
                TmpInsertDatos("insert into kardexdet_tmp2(CODEMPRESA,item,CDARTI,DSARTI, CDALMACEN,DSALMACEN,CDG01,DSG01,UNIDAD,  FECHA,NROMOVI,TIPODOC,NRODOCUM,SALDOINI,INGRESOS,SALIDAS,SALDOFIN,CTOPROM,PRESENTACION,CDPROVEE,COSTOBAS) values('" & codempresa & "', " & k & " ,'" & Trim(tmp_kardexArt.Rows(k)("CDARTI")) & "','" & Trim(tmp_kardexArt.Rows(k)("DSARTI")) & "','" & Trim(tmp_kardexArt.Rows(k)("CDALMACEN")) & "','" & Trim(tmp_kardexArt.Rows(k)("DSALMACEN")) & "','" & Trim(tmp_kardexArt.Rows(k)("CDG01")) & "','" & Trim(tmp_kardexArt.Rows(k)("DSG01")) & "','" & Trim(tmp_kardexArt.Rows(k)("UNIMED")) & "','" & Format(CDate(tmp_kardexArt.Rows(k)("FECHA")), "dd/MM/yyyy") & "','" & Trim(tmp_kardexArt.Rows(k)("NROMOVI")) & "','" & Trim(tmp_kardexArt.Rows(k)("ABRVTIPDOC")) & "','" & Trim(tmp_kardexArt.Rows(k)("NRODOC")) & "'," & saldoini & "," & CDec(tmp_kardexArt.Rows(k)("CI")) & " ," & CDec(tmp_kardexArt.Rows(k)("CS")) & " , " & saldofin & ",0,'" & Present & "','" & Trim(tmp_kardexArt.Rows(k)("CDPROVEE")) & "','" & Trim(tmp_kardexArt.Rows(k)("COSTOBAS")) & "')")
...
#End Region
    ...
    Private Sub BtnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGenerar.Click
        ...
        Try
            With Rpt1
                .ReportFileName = RutaRptInv & CType("RptKardexArticulo2.rpt", String)
