...
Public Class frmTransPrecios2
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Try
            ...
            dt = GetDataExcel("C:2222\PERCEPCION ABRIL 2014.xls", "Recuperado_Hoja1$")
            ...
            For x As Integer = 0 To dt.Rows.Count - 1
                ...
                ' FECHA = String.Format("{0:dd/MM/yyyy}", CDate(dt.Rows(x)("FECHA").ToString.Trim()))

          
                If IsDBNull(dt.Rows(x)("FECHA")) Then
                Else
                    'DateTimePicker1.Value = dt.Rows(x)("FECHA")

                    'FECHA = Format(Microsoft.VisualBasic.DateValue(Me.DateTimePicker1.Value), "MM/dd/yy")
                    FECHA = String.Format("{0:dd/MM/yyyy}", CDate(dt.Rows(x)("FECHA").ToString.Trim()))
                    objStreamWriter.WriteLine(CStr(x) + "|" + "06|" + dt.Rows(x)("RUC").ToString.Trim() + "||" + dt.Rows(x)("ap").ToString.Trim() + "|" + dt.Rows(x)("am").ToString.Trim() + "|" + dt.Rows(x)("nom").ToString.Trim() + "|" + dt.Rows(x)("SERIE").ToString.Trim() + "|" + dt.Rows(x)("NUMERO").ToString.Trim() + "|" + FECHA + "|1|0|0|" + dt.Rows(x)("TOTAL").ToString.Trim() + "|1|" + dt.Rows(x)("SERIE").ToString.Trim() + "|" + dt.Rows(x)("NUMERO").ToString.Trim() + "|" + FECHA + "|" + dt.Rows(x)("TOTAL").ToString.Trim() + "|")
