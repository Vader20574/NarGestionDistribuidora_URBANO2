...
Public Class frmRptVentasCalculosElectronica
    ...
    Private Sub btnmostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnmostrar.Click
        ...
        '        CAyuda.Ejecutar("SP_RPT_VENT_EXFE", rand, codempresa, fechaini.ToShortDateString, fechahas.ToShortDateString, NomTablaD, NomTablaC, 1)
        '    End If

        'Next
        CAyuda.Ejecutar("SP_RPT_VENT_EXFE", rand, codempresa, fechaini.ToShortDateString, fechahas.ToShortDateString)
        dtrpt = New DataTable
    ...
    Private Sub DetallePorDocToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DetallePorDocToolStripMenuItem.Click
        ...
        '    NomTablaD = "VENTD" & Format(DateAdd("m", i, fechaini), "yyyyMM")
        '    If CAyuda.ListarDatos("VERIFICA_HISTORICOVENT", NomTablaC, codempresa).Tables(0).Rows.Count > 0 Then
        '        CAyuda.ListarDatos("SP_RPT_VENTFE", rand, codempresa, dgvcategoria.Item(0, dgvcategoria.CurrentRow.Index).Value.ToString(), fechaini, fechahas, Me.cmbruta.SelectedValue.ToString, Me.cmbfuerza.SelectedValue.ToString)
        '    End If
        'Next
        CAyuda.ListarDatos("SP_RPT_VENTFE", rand, codempresa, dgvcategoria.Item(0, dgvcategoria.CurrentRow.Index).Value.ToString(), fechaini, fechahas, Me.cmbruta.SelectedValue.ToString, Me.cmbfuerza.SelectedValue.ToString)
    ...
    Private Sub DetallePorDocTodosToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DetallePorDocTodosToolStripMenuItem.Click
        ...
        CAyuda.ListarDatos("SP_RPT_VENT_TODOSFE", rand, codempresa, dgvcategoria.Item(0, dgvcategoria.CurrentRow.Index).Value.ToString(), fechaini, fechahas, Me.cmbruta.SelectedValue.ToString, Me.cmbfuerza.SelectedValue.ToString)
