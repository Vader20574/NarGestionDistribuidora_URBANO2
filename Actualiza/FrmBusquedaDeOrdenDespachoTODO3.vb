Public Class FrmBusquedaDeOrdenDespachoTODO3
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBusquedaDeOrdenDespachoTODO3))
        ...
        '
        'FrmBusquedaDeOrdenDespachoTODO3
        '
        ...
        Me.Name = "FrmBusquedaDeOrdenDespachoTODO3"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Busqueda De Orden Venta"
    ...
    Sub CargarDatos(ByVal TIPO As String)
        ...
        For i As Integer = 0 To nromeses
            ...
            If VERIFICA_HISTORICOVENT(NomTablaC) = True Then
                TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO_TODO2  '" & codempresa & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','" & NomTablaC & "','" & GUIAC & "'")
            End If
        Next

        TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO_TODO2  '" & codempresa & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','',''")
