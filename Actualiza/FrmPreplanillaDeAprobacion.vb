Public Class FrmPreplanillaDeAprobacion
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmPreplanillaDeAprobacion))
        ...
        Me.GridNotaCred.Size = New System.Drawing.Size(953, 228)
        ...
        Me.GroupBox4.Location = New System.Drawing.Point(991, 82)
        ...
        '
        'FrmPreplanillaDeAprobacion
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(1113, 372)
        ...
        Me.Name = "FrmPreplanillaDeAprobacion"
...
#Region "FUNCIONES"
    Private Sub FonmatoGrid()
        ...
        DataGridTableStyle1.GridColumnStyles.AddRange(New DataGridTextBoxColumn() {DataColumn9, DataColumn1, DataColumn2, DataColumn3, DataColumn4, DataColumn5, DataColumn6, DataColumn7, DataColumn8, DataColumn10})
                ...
                Case Keys.Enter
                    If GridNotaCred.Focus = True Then
                        If TABLE_NTACREDSERV.Rows.Count > 0 Then
                            ...
                            If GridNotaCred.CurrentCell.ColumnNumber = 6 Then
                                If GridNotaCred.CurrentRowIndex > -1 Then
                                    Dim fr As New Form4
                                    ...
                                    fr.NroDoc = VNroDoc
                                    fr.Producto = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 6).ToString.Trim
                            ...
                            If GridNotaCred.CurrentCell.ColumnNumber = 5 Then
                                If GridNotaCred.CurrentRowIndex > -1 Then
                                    ...
                                    VCdTipoDoc = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 3).ToString.Trim
                                    VNroDoc = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 5).ToString.Trim
                                    fr.FECHA = CDate(GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 9).ToString.Trim)
                            ...
                            If GridNotaCred.CurrentCell.ColumnNumber = 4 Then
                                If GridNotaCred.CurrentRowIndex > -1 Then
                                    Dim fr As New RptAnalisisCobro4
                                    VCdTipoDoc = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 3).ToString.Trim
                                    VNroDoc = GridNotaCred.Item(GridNotaCred.CurrentRowIndex, 5).ToString.Trim
                                    fr.TipoDoc = VCdTipoDoc
                                    fr.NroDoc = VNroDoc
    ...
    Private Sub CargarGrid()
        TABLE_NTACREDSERV = TmpListarDatos("NSP_TRAER_TMP_NRONTACRED  '" & codempresa.Trim & "'")
