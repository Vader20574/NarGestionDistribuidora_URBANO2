Public Class FrmBusquedaDeOrdenDespacho2
    ...
    Sub CargarDatos(ByVal TIPO As String)
        ...
        For i As Integer = 0 To nromeses
            ...
            If TmpListarDatos("VERIFICA_HISTOGUIAINTERNA   '" & codempresa & "','" & NomTablaC & "'  ").Rows.Count <> 0 Then
                TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO3  '" & codempresa & "','" & TIPO & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','" & NomTablaC & "','" & NomTablaD & "'")
            End If
        Next

        TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO3  '" & codempresa & "','" & TIPO & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','',''")

        TABLE_ORDENDESPACHO = TmpListarDatos("NSP_LISTAR_ORDEN_DESPACHO3  '" & rand & "'")
