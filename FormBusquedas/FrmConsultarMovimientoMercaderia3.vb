Public Class FrmConsultarMovimientoMercaderia3
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmConsultarMovimientoMercaderia))
        ...
        Me.GroupBox3.Size = New System.Drawing.Size(1029, 250)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(396, 18)
        ...
        'TxtNroMovi
        '
        Me.TxtNroMovi.Location = New System.Drawing.Point(8, 13)
        ...
        Me.Panel1.Size = New System.Drawing.Size(749, 70)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(553, 6)
        ...
        Me.rbNroDocumento.Location = New System.Drawing.Point(6, 29)
        ...
        Me.rbNroMovimiento.Location = New System.Drawing.Point(6, 9)
        ...
        '
        'FrmConsultarMovimientoMercaderia
        '
        ...
        Me.Name = "FrmConsultarMovimientoMercaderia"
...
#Region "FUNCIONES"
    ...
    Private Sub CargarGrid()
        TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC2'" & codempresa & "','" & INOUT & "'")
    ...
    Sub llenar()
        ...
        For Each dr As DataRow In Table_Filtro.Rows
            ...
            If rbNroMovimiento.Checked = True And TxtNroMovi.Text.Trim.Length <> 0 Then
                TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC_FILTRO2  '" & codempresa & "','" & INOUT & "','" & 0 & "','" & TxtNroMovi.Text & "','" & dr.Item(0).ToString & "'," & 1)
                LLenar_Lista(TABLE_MOV, dr.Item(0).ToString, Movidet)
            End If

            If rbNroDocumento.Checked = True And TxtNroMovi.Text.Trim.Length <> 0 Then
                TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC_FILTRO2  '" & codempresa & "','" & INOUT & "','" & 1 & "','" & TxtNroMovi.Text & "','" & dr.Item(0).ToString & "'," & 1)
                LLenar_Lista(TABLE_MOV, dr.Item(0).ToString, Movidet)
            End If
        Next
        ...
        If rbNroMovimiento.Checked = True And TxtNroMovi.Text.Trim.Length <> 0 Then
            TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC_FILTRO2  '" & codempresa & "','" & INOUT & "','" & 0 & "','" & TxtNroMovi.Text & "',''," & 0)
            LLenar_Lista(TABLE_MOV)
        End If

        If rbNroDocumento.Checked = True And TxtNroMovi.Text.Trim.Length <> 0 Then
            TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC_FILTRO2  '" & codempresa & "','" & INOUT & "','" & 1 & "','" & TxtNroMovi.Text & "',''," & 0)
            LLenar_Lista(TABLE_MOV)
        End If
    ...
    Private Sub BtnFiltrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFiltrar.Click
        ...
        For i As Integer = 0 To nromeses
            ...
            If CAyuda.ListarDatos("SP_VERIFICA_HISTOMOVI", NomTablaC, codempresa).Tables(0).Rows.Count > 0 Then
                TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC_2_2  '" & codempresa & "','" & INOUT & "','" & calmacen.SelectedValue & "','" & fechaini.ToShortDateString & "','" & fechahas.ToShortDateString & "','" & NomTablaC & "'," & 1)
                LLenar_Lista(TABLE_MOV, NomTablaC, NomTablaD)
            End If
        Next

        TABLE_MOV = TmpListarDatos("NSP_LISTAR_MOVIMIENTO_MERC_2_2  '" & codempresa & "','" & INOUT & "','" & calmacen.SelectedValue & "','" & fechaini.ToShortDateString & "','" & fechahas.ToShortDateString & "','" & NomTablaC & "'," & 0)
        LLenar_Lista(TABLE_MOV)
