Public Class FrmBuscPlanillaPago
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DgPlanilla.Size = New System.Drawing.Size(538, 320)
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(538, 44)
        ...
        Me.Name = "FrmBuscPlanillaCobranza"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Buscar Planilla de Cobranza"
...
#Region "Funciones Form"
    ...
    Private Sub CargarGrid()
        TAB_COBRANZAC = TmpListarDatos("SP_LISTAR_PLANILLA_PAGOSCAB  '" & codempresa & "','" & Format(CDate(DtIni.Value), "dd/MM/yyyy") & "','" & Format(CDate(DtFin.Value), "dd/MM/yyyy") & "'")
    ...
    Private Sub FormatoGrid()
        ...
        With Column4
            .MappingName = "FECHAPAGO"
            .HeaderText = "FECHAPAGO"
            .NullText = ""
            .Format = "dd/MM/yyyy"
            .Width = 70
        End With
