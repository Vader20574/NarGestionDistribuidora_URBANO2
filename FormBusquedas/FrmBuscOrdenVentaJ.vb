Public Class FrmBuscOrdenVentaJ
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBuscOrdenVentaJ))
        ...
        Me.GroupBox5.Location = New System.Drawing.Point(431, 306)
        ...
        Me.GridOrdenDesp.Location = New System.Drawing.Point(4, 98)
        Me.GridOrdenDesp.Name = "GridOrdenDesp"
        Me.GridOrdenDesp.ReadOnly = True
        Me.GridOrdenDesp.Size = New System.Drawing.Size(346, 294)
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridTextBoxColumn6, Me.DataGridTextBoxColumn7})
        ...
        'txtOrdenDespacho
        '
        Me.txtOrdenDespacho.Location = New System.Drawing.Point(97, 70)
        ...
        Me.Label4.Location = New System.Drawing.Point(356, 125)
        ...
        'ChkAnul
        '
        Me.ChkAnul.Location = New System.Drawing.Point(273, 70)
        ...
        Me.ClientSize = New System.Drawing.Size(525, 404)
    ...
    Sub CargarDatos(ByVal TIPO As String)
        ...
        For i As Integer = 0 To nromeses
            ...
            If TmpListarDatos("VERIFICA_HISTOGUIAINTERNA   '" & codempresa & "','" & NomTablaC & "'  ").Rows.Count <> 0 Then
                TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO2  '" & codempresa & "','" & TIPO & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','" & NomTablaC & "','" & NomTablaD & "'")
            End If
        Next

        TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO2  '" & codempresa & "','" & TIPO & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','',''")
        ...
        DataGridTableStyle1.GridColumnStyles(5).MappingName = "GUIAC"
        DataGridTableStyle1.GridColumnStyles(6).MappingName = "GUIAD"
