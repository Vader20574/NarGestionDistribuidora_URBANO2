Public Class FrmBusquedaDeOrdenDespacho
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmBusquedaDeOrdenDespacho))
        ...
        Me.Label4.Location = New System.Drawing.Point(474, 88)
        ...
        Me.Name = "FrmBusquedaDeOrdenDespacho"
    ...
    Sub CargarDatos(ByVal TIPO As String)
        ...
        For i As Integer = 0 To nromeses
            ...
            If TmpListarDatos("VERIFICA_HISTOGUIAINTERNA   '" & codempresa & "','" & NomTablaC & "'  ").Rows.Count <> 0 Then
                TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO  '" & codempresa & "','" & TIPO & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','" & NomTablaC & "','" & NomTablaD & "'")
            End If
        Next

        TmpInsertDatos("INS_LISTAR_ORDEN_DESPACHO  '" & codempresa & "','" & TIPO & "','" & FechaIni & "','" & FechaFin & "','" & rand & "','',''")
