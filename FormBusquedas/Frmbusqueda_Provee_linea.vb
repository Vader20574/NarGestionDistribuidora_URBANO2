...
Public Class Frmbusqueda_Provee_linea
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LblTitulo.Text = "VENDEDOR LINEA CREDITO"
        ...
        Me.Name = "Frmbusqueda_Provee_linea"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Vendedor Linea de Credito"
...
#End Region
    Private Sub Frmbusqueda_Stock_Faltante_pedido_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TmpInsertDatos("Delete_Proveelinea  '" & codempresa & "','" & CORREL & "'")
        ...
        If TABLE_PROVEE.Rows.Count > 0 Then
            For x As Integer = 0 To TABLE_PROVEE.Rows.Count - 1
                TmpInsertDatos("SP_RESUM_CRED_PROVEE  '" & codempresa & "','" & CORREL & "','" & CStr(TABLE_PROVEE.Rows(x)(0).ToString) & "'")
            Next

        End If


        Dim TABLE_LISTPROVEE As DataTable
        TABLE_LISTPROVEE = CAyuda.ListarDatos("SP_SELECT_RESUM_PROVEE", codempresa, CORREL).Tables(0)


        GridStockFaltante.DataSource = TABLE_LISTPROVEE
    ...
    Private Sub GridStockFaltante_Navigate(ByVal sender As System.Object, ByVal ne As System.Windows.Forms.NavigateEventArgs) Handles GridStockFaltante.Navigate
