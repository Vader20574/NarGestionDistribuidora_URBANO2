...
Public Class FrmListarArticuloReFactxLinea
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrmListarArticuloReFactxLinea"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lista de  Articulo Refact X Linea"
...
#Region "Funciones"
    ...
    Private Sub CargarGridForm()
        ...
        TABLEART = TmpListarDatos("SP_LISTA_ARTICULO_REFACT  '" & codempresa & "','" & CDZONA & "','" & 0 & "','" & codlinea & "'")
    ...
    Private Sub txtdato_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdato.TextChanged
        ...
        Else
            If rbcodigo.Checked = True Then
                Tabl_temp = CAyuda.ListarDatos("SP_LISTA_ARTICULO_REFACT_FILTRO", codempresa, CDZONA, 0, txtdato.Text.Trim, codlinea).Tables(0)
                GridArt.DataSource = Nothing
                GridArt.DataSource = Tabl_temp
            End If

            If rbdescripcion.Checked = True Then
                Tabl_temp = CAyuda.ListarDatos("SP_LISTA_ARTICULO_REFACT_FILTRO", codempresa, CDZONA, 1, txtdato.Text.Trim, codlinea).Tables(0)
                GridArt.DataSource = Nothing
                GridArt.DataSource = Tabl_temp
            End If
