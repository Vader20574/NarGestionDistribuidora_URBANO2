...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtNumPedido.Location = New System.Drawing.Point(412, 9)
        ...
        Me.PanelSaldoCredito.Location = New System.Drawing.Point(681, 211)
        ...
        Me.btnBusNumPedido.Location = New System.Drawing.Point(594, 10)
        ...
        Me.GrDetalle.Location = New System.Drawing.Point(4, 203)
        ...
        'lbPrecio
        '
        Me.lbPrecio.Location = New System.Drawing.Point(495, 44)
        ...
        Me.Label3.Location = New System.Drawing.Point(453, 48)
        ...
        Me.dgPedido.Location = New System.Drawing.Point(6, 275)
        Me.dgPedido.Name = "dgPedido"
        Me.dgPedido.ReadOnly = True
        Me.dgPedido.Size = New System.Drawing.Size(830, 220)
...
#Region "Fields"
    ...
    Private ActEventComboPresent As Boolean
    Private ActEventComboVend As Boolean
...
#Region "Funciones del Formulario"
    ...
    Private Sub INSERT_TMP_DETALLE()
        ...
        CAyuda.Ejecutar("InsTMP_PEDIDO_VTA_DETxProc", codempresa, txtArticulo.Text, lblArticulo.Text, CDbl(txtCantidad.Text), CDbl(lbPrecio.Text), CDbl(lbPrecio.Text), cbTipoPresent.SelectedValue, cbTipoPresent.Text, CDMONBASE, VCorrelVta, CDZONA, CodUsuario, CboTipoPrecio.SelectedValue, cbTipoPago.SelectedValue, Format(CDate(dtpFecha.Value), "dd/MM/yyyy"), txtCodCliente.Text.ToString())
...
#End Region
    ...
    Private Sub cbTipoPresent_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbTipoPresent.SelectedIndexChanged
        ...
        If ActEventComboPresent = True And txtArticulo.Text.Trim.Length <> 0 Then
                ...
                If TablaTempFzaVtaCliente.Rows.Count > 0 Then 'EVALUANDO SI TIENE LIMITE DE CREDITO X FZA VTA
                    For ContFza As Integer = 0 To TablaTempFzaVtaCliente.Rows.Count - 1 '' ESCOGIENDO FZAVTA SEGUN FZVTA DE VENDEDOR
                        If TablaTempFzaVtaCliente.Rows(ContFza)("CODFUERZA").ToString.Trim = FuerzaVentaVend.Trim Then
                            ...
                            Dim DT As DataTable
                            DT = CAyuda.ListarDatos("SP_SALDODISPONIBLE", codempresa, CboPagador.SelectedValue).Tables(0)


                            If CDbl(DT.Rows(0)("SALDODISPONIBLE")) < CDbl(Me.lbTotalPedido.Text.Trim) Then
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If ValidarGuardar() Then
            ...
            FORMATO_GRID_TMP_DETALLE()
            LimpiarNuevo(True)
            ActEventComboVend = False

            CboVended.Enabled = False
            btnBusVendedor.Enabled = False
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        FORMATO_GRID_TMP_DETALLE()
        LimpiarNuevo(False)
        txtNumPedido.Text = TmpListarDatos("SELECT (ISNULL(NROPEDIDO,0) + 1) FROM  VENDEDOR   WHERE  CODEMPRESA='" & codempresa & "'  AND CODVEND='" & IIf(IsNothing(CboVended.SelectedValue), "", CboVended.SelectedValue) & "'").Rows(0)(0).ToString.Trim
        EstadoGuarda = 1
        ...
        ActEventComboVend = True

        CboVended.Enabled = True
        btnBusVendedor.Enabled = True
    ...
    Private Sub btnBusNumPedido_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBusNumPedido.Click
        ...
        Try
            ...
            ' ComboBox1.SelectedValue = TablaCabPedido.Rows(0)("CODALMACEN").ToString.Trim
...
#End Region
    ...
    Private Sub CboVended_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CboVended.SelectedIndexChanged
        If ActEventComboVend = True Then
            txtNumPedido.Text = TmpListarDatos("SELECT ISNULL(NROPEDIDO,0) + 1 FROM  VENDEDOR   WHERE  CODEMPRESA='" & codempresa & "'  AND CODVEND='" & IIf(IsNothing(CboVended.SelectedValue), "", CboVended.SelectedValue) & "'").Rows(0)(0).ToString.Trim
        End If
    End Sub
