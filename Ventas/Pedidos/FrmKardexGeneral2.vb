Public Class FrmKardexGeneral2
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.LstCat2.Size = New System.Drawing.Size(232, 316)
        ...
        Me.LstCat1.Size = New System.Drawing.Size(232, 316)
...
#End Region
    ...
    Private Sub BtnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGenerar.Click
        ...
        Dim SQL As String
        SQL = "DELETE_TMP_TIPO_DOC "
        If TmpInsertDatos(SQL) = True Then
        End If

        SQL = "DELETE_ACTUALIZAR_STOCK "
        If TmpInsertDatos(SQL) = True Then
        End If
        ...
        For k As Integer = 0 To ListaV2.Count - 1
            ...
            SQL = "INSERT_TMP_TIPO_DOC '" & ListaV2.Item(k).CODIGO.ToString & "'"
            If TmpInsertDatos(SQL) = True Then
            End If
        Next
        ...
        '        CboAlmacen.SelectedValue = Table_Correlativo.Rows(i)(1).ToString()
    ...
    Sub Generar_NewReporte()
        ...
        Dim CodArti, CodPres, DsPresent, Cadena As String
...
RegEquiv:
    ...
    Sub Procesar_Saldo(ByVal fechaCierre As String)
        ...
        If CierreIgual = True Then
            ...
            For i As Integer = 0 To meses
                ...
                If VERIFICA_HISTORICOVENT(VentaC) = True Then
                    ...
                    End If
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_VENTAS_N '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & VentD & "',0,'" & rand & "'")
                End If
            Next
        ...
        Else
            ...
            For i As Integer = 0 To meses
                ...
                If VERIFICA_HISTORICOVENT(VentaC) = True Then
                    ...
                    End If
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_VENTAS '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','" & VentD & "',0,'" & rand & "'")
                End If
            Next
        ...
        TmpInsertDatos("INS_ACTUALIZAR_STOCK '" & rand & "'")
