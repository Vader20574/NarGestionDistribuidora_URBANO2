...
Public Class FrmListarArticuloFact3
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FrmListarArticuloFact3"
...
#Region "Funciones"
    ...
    Private Sub CargarGridForm()
        ...
        TABLEART = TmpListarDatos("SP_LISTA_ARTICULO_FACT  '" & codempresa & "','" & CDZONA & "','" & 0 & "'")
    ...
    Private Sub txtdato_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdato.TextChanged
        ...
        Else
            If rbcodigo.Checked = True Then
                Tabl_temp = CAyuda.ListarDatos("SP_LISTA_ARTICULO_FACT_FILTRO", codempresa, CDZONA, 0, txtdato.Text.Trim).Tables(0)
                GridArt.DataSource = Nothing
                GridArt.DataSource = Tabl_temp
            End If

            If rbdescripcion.Checked = True Then
                Tabl_temp = CAyuda.ListarDatos("SP_LISTA_ARTICULO_FACT_FILTRO", codempresa, CDZONA, 1, txtdato.Text.Trim).Tables(0)
                GridArt.DataSource = Nothing
                GridArt.DataSource = Tabl_temp
            End If
