...
Public Class FrmConsProv_Trans
...
#End Region
    ...
    Public ObjProv As New FrmProveedor_trans


    Public chofer As New frm_choferes3
    ...
    Private Sub Cargar_Grilla(ByVal pCod As String, ByVal pDes As String)
        Try
            TblProv = CAyuda.ListarDatos("USP_CONSULTAR_PROVEEDOR_Trans", pCod, pDes, codempresa).Tables(0)
    ...
    Private Sub Devuelve()
        Try
            With Me.DtgProv
                ...
                TblBusProv = CAyuda.ListarDatos("USP_BUSCAR_PROVEEDOR_Trans", Trim(.Item(.CurrentRowIndex, 0).ToString()), codempresa.Trim).Tables(0)
                If TblBusProv.Rows.Count = 1 Then
                    With TblBusProv
                        If xAyuda = 1 Then
                            ...
                            chofer.txt_ESubContr.Text = CAyuda.ValidaNulls(Trim(.Rows(0).Item("CODPROVEEDOR").ToString()))
                            chofer.lblEmpCont.Text = CAyuda.ValidaNulls(Trim(.Rows(0).Item("DESPROVEEDOR").ToString()))
                        ...
                        Else
                            ...
                            ObjProv.CheckBox1.Checked = CAyuda.ValidaNulls(Trim(.Rows(0).Item("activo").ToString()))
