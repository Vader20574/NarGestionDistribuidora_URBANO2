...
Public Class frm_Vehiculo_Carre
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_Vehiculo_Carre))
        ...
        Me.BTNELIMINAR.Location = New System.Drawing.Point(731, 134)
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(108, 8)
        Me.GroupBox1.Name = "GroupBox1"
        Me.GroupBox1.Size = New System.Drawing.Size(468, 665)
        ...
        Me.Label32.Location = New System.Drawing.Point(55, 600)
        ...
        Me.txtRueda.Location = New System.Drawing.Point(104, 598)
        Me.txtRueda.MaxLength = 150
        Me.txtRueda.Name = "txtRueda"
        Me.txtRueda.Size = New System.Drawing.Size(357, 21)
        Me.txtRueda.TabIndex = 124
        '
        'Label31
        '
        Me.Label31.AutoSize = True
        Me.Label31.Location = New System.Drawing.Point(50, 576)
        ...
        Me.Label30.Location = New System.Drawing.Point(30, 549)
        ...
        Me.txtSerieClases.TabIndex = 122
        '
        'Label29
        '
        ...
        Me.Label26.Text = "Fecha Vta del Certif:"
        ...
        Me.dtpFechaReg.Location = New System.Drawing.Point(108, 242)
        ...
        Me.txtNroSoat.Location = New System.Drawing.Point(107, 514)
        ...
        Me.txtPrecioB.Location = New System.Drawing.Point(103, 269)
        ...
        Me.txtPartRegi.Location = New System.Drawing.Point(106, 215)
        ...
        Me.txtAñoF.Location = New System.Drawing.Point(105, 163)
        ...
        Me.txtMarca.Location = New System.Drawing.Point(105, 136)
        ...
        Me.txtModelo.Location = New System.Drawing.Point(104, 87)
        ...
        'CheckBox1
        '
        Me.CheckBox1.Location = New System.Drawing.Point(246, 237)
        ...
        Me.ckActivo.Location = New System.Drawing.Point(103, 625)
        Me.ckActivo.Name = "ckActivo"
        Me.ckActivo.Size = New System.Drawing.Size(15, 14)
        Me.ckActivo.TabIndex = 126
        Me.ckActivo.UseVisualStyleBackColor = True
        '
        'Label33
        '
        Me.Label33.AutoSize = True
        Me.Label33.Location = New System.Drawing.Point(54, 625)
        ...
        Me.ClientSize = New System.Drawing.Size(714, 708)
        ...
        Me.Name = "frm_Vehiculo_Carre"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Registro Vehiculo Carreteras"
...
#End Region
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If MsgBox("Desea Eliminar Este Registro que Selecciono", MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, "NAR SISTEMAS S.A.C") = MsgBoxResult.Yes Then
            ...
            Dim sql As String
            sql = "nsp_dele_VEHICULO_CARRETERAS '" & tcodigo.Text & "','" & Microsoft.VisualBasic.DateValue(Now) & "','" & CodUsuario & "','" & codempresa & "'"
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If INTFLAGVEND = 0 Then
            ...
            dt = CAyuda.ListarDatos("SP_VERIFI_ID_VEHICULO_CARRETERAS", tcodigo.Text.Trim).Tables(0)
        ...
        If INTFLAGVEND = 1 Then
            Dim RptaTrans As Boolean
            RptaTrans = CAyuda.Ejecutar("NSP_UPD_VEHICULO_CARRETERAS", codempresa, tcodigo.Text.Trim, tplaca.Text.Trim, txtClase.Text, txtModelo.Text.Trim, txtColor.Text.Trim, txtMarca.Text.Trim, txtAñoF.Text.Trim, txtMotor.Text.Trim, txtPartRegi.Text.Trim, dtpFechaReg.Value.ToShortDateString, txtPrecioB.Text.Trim, txtPneto.Text.Trim, txtUtil.Text.Trim, txtLong.Text.Trim, txtAncho.Text.Trim, txtAltura.Text.Trim, txtNroCertif.Text.Trim, dtpFechaVta.Value.ToShortDateString, dtpFechaVence.Value.ToShortDateString, txtNroSoat.Text, txtSerieClases.Text, txtClilindro.Text, txtRueda.Text, Activo)
    ...
    Private Sub btnreporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreporte.Click
        ...
        Try
            ...
            crRpt.ReportFileName = rutareporte & "RepVehiCarreteras.rpt"
