...
#End Region
    Public vie As frm_Vehiculo_Carre
    ...
    Sub cargadatos()
        Call Cargagrid(grid1, "Nsp_Select_VEHICULO_TRAILER '" & codempresa & "'")
    End Sub
    ...
    Sub pasadatos()
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_VEHICULO_CARRETERAS", codempresa, grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                ...
                vie.tplaca.Text = TablaVend.Rows(0)("PLACA")

                vie.txtClase.Text = TablaVend.Rows(0)("CLASE")
                vie.txtModelo.Text = TablaVend.Rows(0)("MODELO")


                vie.txtColor.Text = TablaVend.Rows(0)("COLOR")
                vie.txtMarca.Text = TablaVend.Rows(0)("MARCA")
                vie.txtAñoF.Text = TablaVend.Rows(0)("AÑOF")
                vie.txtMotor.Text = TablaVend.Rows(0)("MOTOR")
                vie.txtPartRegi.Text = TablaVend.Rows(0)("PARTREGI")
                vie.dtpFechaReg.Value = TablaVend.Rows(0)("FECHA_REF")
                vie.txtPrecioB.Text = TablaVend.Rows(0)("PBRUTO")
                vie.txtPneto.Text = TablaVend.Rows(0)("PNETO")
                vie.txtUtil.Text = TablaVend.Rows(0)("CUTIL")
                vie.txtLong.Text = TablaVend.Rows(0)("LONGITUD")
                vie.txtAncho.Text = TablaVend.Rows(0)("ANCHO")
                vie.txtAltura.Text = TablaVend.Rows(0)("ALTURA")
                vie.txtNroCertif.Text = TablaVend.Rows(0)("NROCERT")
                vie.dtpFechaVta.Value = TablaVend.Rows(0)("FECHA_VTA")
                vie.dtpFechaVence.Value = TablaVend.Rows(0)("FECHA_VENC")
                vie.txtNroSoat.Text = TablaVend.Rows(0)("NROSOAT")

                vie.txtSerieClases.Text = TablaVend.Rows(0)("serieC")
                vie.txtClilindro.Text = TablaVend.Rows(0)("Cilindro")
                vie.txtRueda.Text = TablaVend.Rows(0)("Rueda")
                vie.CheckBox1.Checked = TablaVend.Rows(0)("Activo")
        ...
        Else
            ...
            vie1.txt_carretera.Text = TablaVend.Rows(0)("CODVEND")
            vie1.lbl_carretera.Text = TablaVend.Rows(0)("PLACA")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select codvend as codigo,placa as banco from VEHICULO_CARRETERAS  where codempresa='" & codempresa & "'", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,placa as banco from VEHICULO_CARRETERAS  where (codvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,placa as banco from VEHICULO_CARRETERAS  where (estado=0 and dsvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
