...
#End Region
    Public vie As frm_Vehiculo_Traile
    ...
    Sub pasadatos()
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_VEHICULO_TRAILER", codempresa, grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
        ...
        Else
            ...
            vie1.txt_trailer.Text = TablaVend.Rows(0)("CODVEND")
            vie1.lbl_trailer.Text = TablaVend.Rows(0)("PLACA")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select codvend as codigo,placa as banco from VEHICULO_TRAILER  where codempresa='" & codempresa & "'", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,placa as banco from VEHICULO_TRAILER  where (codvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select codvend as codigo,placa as banco from VEHICULO_TRAILER  where (estado=0 and dsvend like '" & Me.txtdato.Text.Trim & "%' and codempresa='" & codempresa & "') ", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
