...
#End Region
    ...
    Sub cargadatos()
        Call Cargagrid(grid1, "Nsp_Select_SERVICIO_PROPIO '" & codempresa & "'")
    End Sub
    ...
    Sub pasadatos()
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_SERVICIO_PROPIO", grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then

                vie.txt_Codigo.Text = TablaVend.Rows(0)("codigo")
                vie.Dt_FechaReg.Value = TablaVend.Rows(0)("Fecha")
                vie.txt_cliente.Text = TablaVend.Rows(0)("cliente")
                vie.txt_chofer.Text = TablaVend.Rows(0)("chofer")
                vie.txt_trailer.Text = TablaVend.Rows(0)("vehiculo_trayler")
                vie.txt_carretera.Text = TablaVend.Rows(0)("vehiculo_carretera")
                vie.dt_fechai.Value = TablaVend.Rows(0)("fecha_inicio")
                vie.dt_fechaf.Value = TablaVend.Rows(0)("fecha_cierre")
                vie.txt_puntoPart.Text = TablaVend.Rows(0)("Punto_Partida")
                vie.cbopaisP.SelectedValue = TablaVend.Rows(0)("Cod_Pais_P")
                vie.cdepaP.SelectedValue = TablaVend.Rows(0)("Cod_departamento_P")
                vie.cciudP.SelectedValue = TablaVend.Rows(0)("Cod_Provincia_P")
                vie.cdistritoP.SelectedValue = TablaVend.Rows(0)("Cod_Distrito_P")
                vie.txtDistinario.Text = TablaVend.Rows(0)("Distinatario")
                vie.txtPllegada.Text = TablaVend.Rows(0)("Punto_Llegada")
                vie.cbopaisL.SelectedValue = TablaVend.Rows(0)("Cod_Pais_L")
                vie.cdepaL.SelectedValue = TablaVend.Rows(0)("Cod_departamento_L")
                vie.cciudL.SelectedValue = TablaVend.Rows(0)("Cod_Provincia_L")
                vie.cdistritoL.SelectedValue = TablaVend.Rows(0)("Cod_Distrito_L")
                vie.txt_prodTrans.Text = TablaVend.Rows(0)("Produc_Trans")
                vie.txt_precPact.Text = TablaVend.Rows(0)("Preci_Pact")
                vie.txtGuiaRemiT.Text = TablaVend.Rows(0)("GR_Trans")
                vie.txtGuiaRemiR.Text = TablaVend.Rows(0)("GR_Remit")
                vie.txtCondPago.Text = TablaVend.Rows(0)("CondPago")
                vie.KRCargador.Text = TablaVend.Rows(0)("KR_Cargado")
                vie.KRsinCarga.Text = TablaVend.Rows(0)("KR_SinCargo")
                vie.kr_total.Text = TablaVend.Rows(0)("KR_Total")
                vie.ga_ultima.Text = TablaVend.Rows(0)("KG_Utilizados")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select codigo as codigo,cliente as banco from TB_SERVICIO_PROPIO ", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select codigo as codigo,cliente as banco from TB_SERVICIO_PROPIO where (codigo like '" & Me.txtdato.Text.Trim & "'", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select codigo as codigo,cliente as banco from TB_SERVICIO_PROPIO where ( cliente like '" & Me.txtdato.Text.Trim & "'", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
