...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_clie_Transp))
        ...
        Me.ctipoclie.Location = New System.Drawing.Point(941, 398)
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(851, 27)
        ...
        Me.TabControl1.Size = New System.Drawing.Size(833, 456)
        ...
        Me.TabPage1.Size = New System.Drawing.Size(825, 430)
        Me.TabPage1.TabIndex = 0
        Me.TabPage1.Text = "Datos Generales"
        '
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(534, 243)
        ...
        'PictureBox2
        '
        Me.PictureBox2.Location = New System.Drawing.Point(534, 280)
        ...
        'PictureBox1
        '
        Me.PictureBox1.Location = New System.Drawing.Point(338, 280)
        ...
        'Button2
        '
        Me.Button2.Location = New System.Drawing.Point(338, 243)
        ...
        Me.CboTipoNegocio.Visible = False
        '
        'Label23
        '
        ...
        Me.CboTipoprecio.Visible = False
        '
        'cmbcalle__
        '
        ...
        Me.TabPage4.Size = New System.Drawing.Size(825, 430)
        ...
        'Button5
        '
        Me.Button5.Location = New System.Drawing.Point(487, 105)
        ...
        'BtnQuitDep
        '
        Me.BtnQuitDep.Location = New System.Drawing.Point(487, 75)
        ...
        Me.GridCliDep.Size = New System.Drawing.Size(801, 195)
        ...
        'BtnAgregDep
        '
        Me.BtnAgregDep.Location = New System.Drawing.Point(487, 45)
        ...
        Me.TabPage2.Size = New System.Drawing.Size(825, 430)
        ...
        Me.TxtTotLimCred.Visible = False
        '
        'Label48
        '
        ...
        Me.TxtLineaUtilidad.Visible = False
        '
        'TxtTotSaldoDisp
        '
        ...
        Me.TxtTotSaldoDisp.Visible = False
        '
        'GroupBox3
        '
        ...
        Me.TabPage3.Size = New System.Drawing.Size(825, 430)
        ...
        Me.Rpt1.Location = New System.Drawing.Point(1076, 316)
        Me.Rpt1.Name = "Rpt1"
        ...
        Me.ClientSize = New System.Drawing.Size(1345, 614)
        ...
        Me.Name = "frm_clie_Transp"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Registro de Clientes Transporte"
...
#Region "Funciones Form"
    ...
    Private Sub BuscarCliente()
        ...
        TB_BUSQCLIDEP = TmpListarDatos("BUSQ_CLIDEP_TRANS '" & codempresa & "','" & VAR1 & "'")
        If TB_BUSQCLIDEP.Rows.Count > 0 Then
            VAR1 = TB_BUSQCLIDEP.Rows(0)(1).ToString()
        End If


        Conecta("SP_TraerClienteMaest_TRANS '" & codempresa & "','" & VAR1 & "','" & CodUsuario & "'", "pa")
    ...
    Public Sub CargarGridCliDep()
        TMP_CLIDEP = TmpListarDatos("SP_LISTAR_TMP_CLIENTE_TRANS  '" & codempresa & "','" & tcodigo.Text & "','" & CodUsuario & "'")
    ...
    Public Sub FormatoGridCliDep()
        ...
        TableStyle1.GridColumnStyles.AddRange(New DataGridTextBoxColumn() {Column1, Column2, Column3, Column4, Column6, Column7})

        TableStyle1.GridColumnStyles.AddRange(New DataGridBoolColumn() {Column5})
...
#End Region
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        sql = "nsp_dele_cliente_trans '" & tcodigo.Text & "','" & Microsoft.VisualBasic.DateValue(Now) & "','" & CodUsuario & "','" & codempresa & "'"
        TmpInsertDatos(sql)
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        Try
            ...
            If FLAG = 1 Then
                ...
                If Me.cciud.Text.Trim = "" Then
                    sql = "NSP_upd_CLIENTE_TRANS " & tdescuento.Text & ",'" & tctaletra.Text & "','" & tctaanticipo.Text & "','" & tctaventa.Text & "'," & CDbl(TxtTotSaldoDisp.Text) & "," & CDbl(TxtTotLimCred.Text) & ",'" & ttelefono.Text & "','" & truc.Text & "','" & tdireccion.Text & "','" & tcodigo.Text & "','" & ctipopago.SelectedValue.ToString & "','" & "0" & "','','" & codempresa & "'," & 0 & "," & 0 & "," & 0 & ",'" & trazon.Text & "','" & tmaterno.Text & "','" & tpaterno.Text & "','" & tnombre.Text & "','" & "" & "','" & tdni.Text & "','" & tmail.Text & "','" & Format(Microsoft.VisualBasic.DateValue(Now), "MM/dd/yy") & "','" & CodUsuario & "','" & formaPago & "','" & cmbmoneda.SelectedValue.ToString() & "','" & cbopais.SelectedValue.ToString & "','" & txtcontacto.Text & "','" & txttelefonoc.Text & "','" & txtcelularc.Text & "','" & txtemailc.Text & "','" & txtfax.Text & "','" & cdepa.SelectedValue.ToString & "',0," & EMP & ",'" & comboRuta.SelectedValue.ToString & "','" & CboTipoNegocio.SelectedValue.ToString & "','" & CboTipoprecio.SelectedValue.ToString & "'," & ACTIVOCLIENTE & ",'" & rutaimagen & "','" & rutaimagen2 & "'"
                ElseIf Me.cdistrito.Text.Trim = "" Then
                    sql = "NSP_upd_CLIENTE_TRANS " & tdescuento.Text & ",'" & tctaletra.Text & "','" & tctaanticipo.Text & "','" & tctaventa.Text & "'," & CDbl(TxtTotSaldoDisp.Text) & "," & CDbl(TxtTotLimCred.Text) & ",'" & ttelefono.Text & "','" & truc.Text & "','" & tdireccion.Text & "','" & tcodigo.Text & "','" & ctipopago.SelectedValue.ToString & "','" & "0" & "','" & cciud.SelectedValue.ToString & "','" & codempresa & "',0,0,0,'" & trazon.Text & "','" & tmaterno.Text & "','" & tpaterno.Text & "','" & tnombre.Text & "','" & "" & "','" & tdni.Text & "','" & tmail.Text & "','" & Format(Microsoft.VisualBasic.DateValue(Now), "MM/dd/yy") & "','" & CodUsuario & "','" & formaPago & "','" & cmbmoneda.SelectedValue.ToString() & "','" & cbopais.SelectedValue.ToString & "','" & txtcontacto.Text & "','" & txttelefonoc.Text & "','" & txtcelularc.Text & "','" & txtemailc.Text & "','" & txtfax.Text & "','" & cdepa.SelectedValue.ToString & "',0," & EMP & ",'" & comboRuta.SelectedValue.ToString & "','" & CboTipoNegocio.SelectedValue.ToString & "','" & CboTipoprecio.SelectedValue.ToString & "'," & ACTIVOCLIENTE & ",'" & rutaimagen & "','" & rutaimagen2 & "'"
                Else
                    sql = "NSP_upd_CLIENTE_TRANS " & tdescuento.Text & ",'" & tctaletra.Text & "','" & tctaanticipo.Text & "','" & tctaventa.Text & "'," & CDbl(TxtTotSaldoDisp.Text) & "," & CDbl(TxtTotLimCred.Text) & ",'" & ttelefono.Text & "','" & truc.Text & "','" & tdireccion.Text & "','" & tcodigo.Text & "','" & ctipopago.SelectedValue.ToString & "','" & "0" & "','" & cciud.SelectedValue.ToString & "','" & codempresa & "',0,0,0,'" & trazon.Text & "','" & tmaterno.Text & "','" & tpaterno.Text & "','" & tnombre.Text & "','" & "" & "','" & tdni.Text & "','" & tmail.Text & "','" & Format(Microsoft.VisualBasic.DateValue(Now), "MM/dd/yy") & "','" & CodUsuario & "','" & formaPago & "','" & cmbmoneda.SelectedValue.ToString() & "','" & cbopais.SelectedValue.ToString & "','" & txtcontacto.Text & "','" & txttelefonoc.Text & "','" & txtcelularc.Text & "','" & txtemailc.Text & "','" & txtfax.Text & "','" & cdepa.SelectedValue.ToString & "'," & Me.cdistrito.SelectedValue.ToString & "," & EMP & ",'" & comboRuta.SelectedValue.ToString & "','" & CboTipoNegocio.SelectedValue.ToString & "','" & CboTipoprecio.SelectedValue.ToString & "'," & ACTIVOCLIENTE & ",'" & rutaimagen & "','" & rutaimagen2 & "'"
                ...
                If TmpInsertDatos(sql) = True Then
                    MsgBox("SE MODIFICO CORRECTAMENTE EL REGISTRO", MsgBoxStyle.Information, "")
                    Guardar_Nextel()
    ...
    Private Sub btnreporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreporte.Click
        Try
            ...
            Rpt1.ReportFileName = rutareporte & "Rpt_Clientes_Trans.rpt"
    ...
    Private Sub BtnAgregDep_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAgregDep.Click
        ...
        If TmpInsertDatos("SP_INSTMP_CLIDEP   '" & codempresa & "','" & CodUsuario & "','" & tcodigo.Text & "','" & TxtCodDep.Text & "','" & TxtRzSocialDep.Text & "','" & CboRutaDep.SelectedValue & "','" & cmbdist.SelectedValue & "'," & CDbl(txtMPercepcion.Text) & "," & CInt(ck_Nota_Pedido.Checked)) Then
            ...
            If TmpInsertDatos("SP_UPD_COD_CLIDEP   '" & codempresa & "','" & CodUsuario & "','" & ITEM & "','" & CODIGODEP & "'," & CInt(ck_Nota_Pedido.Checked) & "") Then

            End If

            If TmpInsertDatos("SP_INSTMP_CLIENTE  '" & codempresa & "','" & CODIGODEP & "','" & TxtRzSocialDep.Text & "','" & TxtRucDep.Text & "','" & TxtDirecDep.Text & "','" & CboRutaDep.SelectedValue & "','" & tcodigo.Text & "','" & CodUsuario & "','" & cmbciudad.SelectedValue & "','" & cmbdist.SelectedValue & "'," & 0 & ",'" & "0" & "','" & ctipopago.SelectedValue & "','" & CDbl(txtMPercepcion.Text) & "'") = False Then
                Exit Sub
            End If
        ...
        If TMP_CLIDEP.Rows.Count > 0 Then
            ...
            If TMP_CLIDEP.Rows.Count > 0 Then
                For x As Integer = 0 To TMP_CLIDEP.Rows.Count - 1
                    ...
                    CORREL1 = Microsoft.VisualBasic.Left(tcodigo.Text, 3)
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        If TmpInsertDatos("SP_UPDTMP_CLIDEP   '" & codempresa & "','" & CodUsuario & "','" & tcodigo.Text & "','" & TxtCodDep.Text & "','" & TxtRzSocialDep.Text & "','" & CboRutaDep.SelectedValue & "','" & cmbdist.SelectedValue & "'," & CDbl(txtMPercepcion.Text) & "," & CInt(ck_Nota_Pedido.Checked)) Then
            If TmpInsertDatos("SP_UPDTMP_CLIENTE  '" & codempresa & "','" & TxtCodDep.Text & "','" & TxtRzSocialDep.Text & "','" & TxtRucDep.Text & "','" & TxtDirecDep.Text & "','" & CboRutaDep.SelectedValue & "','" & tcodigo.Text & "','" & CodUsuario & "','" & cmbciudad.SelectedValue & "','" & cmbdist.SelectedValue & "'," & 0 & ",'" & "0" & "','" & ctipopago.SelectedValue & "','" & CDbl(txtMPercepcion.Text) & "'") = False Then
                Exit Sub
            End If
