...
#End Region
    ...
    Sub cargadatos()
        Call Cargagrid(grid1, "NSP_LISTAR_SERVICIO_TERCERO '" & codempresa & "'")
    End Sub
    ...
    Sub pasadatos()
        ...
        Dim TablaVend As New DataTable
        TablaVend = CAyuda.ListarDatos("NSP_LISTAR_SERVICIO_TERCERO", grid1.Item(grid1.CurrentRowIndex, 0)).Tables(0)
        If bol = True Then
            If TablaVend.Rows.Count > 0 Then
                ...
                vie.txt_ESubContr.Text = TablaVend.Rows(0)("empresa_SubCont")
                vie.txt_MVehiculo.Text = TablaVend.Rows(0)("Marc_vehiculo")
                vie.txt_ptracto.Text = TablaVend.Rows(0)("Placa_Tracto")
                vie.txt_pCarretera.Text = TablaVend.Rows(0)("Placa_Carretera")
                vie.txt_Chofer.Text = TablaVend.Rows(0)("Chofer")
                vie.txt_Lic_Chofer.Text = TablaVend.Rows(0)("Lic_Chofer")
                ...
                vie.txtCondPago.Text = TablaVend.Rows(0)("Cons_Pago")
                vie.txtGuiaRemiT.Text = TablaVend.Rows(0)("GR_Trans")
                vie.txtGuiaRemiR.Text = TablaVend.Rows(0)("GR_Remit")
                vie.txtGuiaRemiSC.Text = TablaVend.Rows(0)("GR_SubContrato")
    ...
    Sub llena()
        Try
            ...
            If Me.txtdato.Text.Trim = "" Then
                ...
                Conecta("select codigo as codigo,cliente as banco from TB_SERVICIO_TERCERO ", "pa")
            ...
            Else
                If Me.rbcodigo.Checked = True Then
                    ...
                    Me.Dsgridbanco1.Clear()
                    Conecta("select codigo as codigo,cliente as banco from TB_SERVICIO_TERCERO where (codigo like '" & Me.txtdato.Text.Trim & "'", "pa")
                    Me.grid1.DataSource = ds.Tables(0)

                Else

                    Me.Dsgridbanco1.Clear()
                    Conecta("select codigo as codigo,cliente as banco from TB_SERVICIO_TERCERO where ( cliente like '" & Me.txtdato.Text.Trim & "'", "pa")
                    Me.grid1.DataSource = ds.Tables(0)
