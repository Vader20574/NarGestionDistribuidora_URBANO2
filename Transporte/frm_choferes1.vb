...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_choferes1))
        ...
        Me.Label20.Location = New System.Drawing.Point(256, 179)
        ...
        Me.txtctaBanca.Location = New System.Drawing.Point(314, 174)
        ...
        Me.Label19.Location = New System.Drawing.Point(31, 174)
        ...
        Me.Label15.Location = New System.Drawing.Point(247, 147)
        ...
        Me.Label11.Location = New System.Drawing.Point(247, 118)
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If INTFLAGVEND = 0 Then
            ...
            dt = CAyuda.ListarDatos("SP_VERIFI_ID_CHOFERES", tcodigo.Text.Trim).Tables(0)
            ...
            RptaTrans = CAyuda.Ejecutar("NSP_ins_CHOFERES", codempresa, tcodigo.Text.Trim, tvendedor.Text.Trim, txtDNI.Text.Trim, txtTelefono.Text.Trim, dtpFechaReg.Value.ToShortDateString, txtDirec.Text.Trim, txtctaBanca.Text, cciudad.SelectedValue, TxtNropedido.Text, Me.cbFuerzaVenta.SelectedValue, "", Now, CodUsuario, TxtNropedido.Text, txtLineaCred.Text, TIPOVEND, CheckBox1.Checked)
            If RptaTrans Then
        ...
        If INTFLAGVEND = 1 Then
            Dim RptaTrans As Boolean
            RptaTrans = CAyuda.Ejecutar("NSP_UPD_CHOFERES", codempresa, tcodigo.Text.Trim, tvendedor.Text.Trim, txtDNI.Text.Trim, txtTelefono.Text.Trim, dtpFechaReg.Value.ToShortDateString, txtDirec.Text.Trim, txtctaBanca.Text, cciudad.SelectedValue, TxtNropedido.Text, Me.cbFuerzaVenta.SelectedValue, "", Now, CodUsuario, TxtNropedido.Text, txtLineaCred.Text, TIPOVEND, CheckBox1.Checked)
    ...
    Private Sub btnreporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnreporte.Click
        Try
            ...
            crRpt.ReportFileName = rutareporte & "rptChofer.rpt"
