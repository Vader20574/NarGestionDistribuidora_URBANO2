Public Class frmEstadoInv
    ...
    Private Sub btngenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btngenerar.Click
        ...
        Try
            CAyuda.Ejecutar("SP_INSERT_TMP_UTILIDAD2", codempresa, Format(DtFechaFin.Value, "dd/MM/yyyy"), rand)
            CAyuda.Ejecutar("SP_INSERT_TMP_UTILIDAD_30", codempresa, Format(DtFechaFin.Value, "dd/MM/yyyy"), rand)
    ...
    Private Sub frmEstadoInv_MaximizedBoundsChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.MaximizedBoundsChanged
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            ...
            With Rpt1
                ...
                .ReportFileName = RutaRptInv & CType("Rpt_ValorizacionXlinea.rpt", String)
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        Try
            ...
            With Rpt1
                ...
                .ReportFileName = RutaRptInv & CType("Rpt_ValorizacionXSublinea.rpt", String)
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        Try
            With Rpt1
                .ReportFileName = RutaRptInv & "Rpt_Cuadre_Ventas5.rpt"
                .Connect = "DSN=reportes;UID=" & usuariodb & ";PWD=" & Trim(passworddb) & ";"
                .set_Formulas(0, "Empresa='" & DesEmpresa & "'")
                .set_Formulas(1, "Usuario='" & DesUsuario & "'")
                '.set_Formulas(2, "FechaIni='" & Fechari & "'")
                '.set_Formulas(3, "FechaH='" & Fecharf & "'")
