Public Class FrmKardexGeneralProtisa
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmKardexGeneralProtisa))
        ...
        Me.Name = "FrmKardexGeneralProtisa"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Reporte Protisa"
...
#End Region
    ...
    Private Sub FrmKardexGeneral_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Tb_Categ1 = TmpListarDatos("SELECT  CODLINEA,DESLINEA  FROM LINEA  WHERE   CODEMPRESA='" & codempresa & "' AND CODLINEA='002'")
...
RegEquiv:
    ...
    Sub Procesar_Saldo(ByVal fechaCierre As String)
        ...
        If CierreIgual = True Then
            ...
            TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_INGSALXARTI1 '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'MOVIDET',0,'" & rand & "'")
            ...
            For i As Integer = 0 To meses
                ...
                If TmpListarDatos("VERIFICA_HISTORICOMOVI '" & codempresa & "','" & MoviC & "'").Rows.Count <> 0 Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_INGSALXARTI1 '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & MoviD & "',1,'" & rand & "'")

                End If
                If VERIFICA_HISTORICOVENT(VentaC) = True Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_VENTAS_NXARTI1 '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & VentD & "','" & VentaC & "','" & rand & "'")
        ...
        Else
            ...
            TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_INGSALXARTICULO1 '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','MOVIDET',0,'" & rand & "'")
            ...
            For i As Integer = 0 To meses
                ...
                If TmpListarDatos("VERIFICA_HISTORICOMOVI '" & codempresa & "','" & MoviC & "'").Rows.Count <> 0 Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_INGSALXARTICULO1 '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','" & MoviD & "',1,'" & rand & "'")

                End If
                If VERIFICA_HISTORICOVENT(VentaC) = True Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_VENTASXARTICULO1 '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','" & VentD & "','" & VentaC & "','" & rand & "'")
                End If
            Next
    ...
    Private Sub INSERTCIERREALDIA(ByVal FechaCierre As Date)
        If Todo_Cate = 1 Then
            TmpInsertDatos("INSERT INTO TMP_KARDEX (CORREL,CODEMPRESA,CDALMA, CDG01, CDARTI, STOCKINI, STOCKREC, COMPRAS, INGAJUSTE, INGTRANSF, INGOTROS,VENTAS, SALAJUSTE, SALTRANSF, SALOTROS )  " &
                          ...
                          "FROM Cierre_Inv_protisa,ARTICULO WHERE Cierre_Inv_protisa.ARTICULO=ARTICULO.CODARTI AND ARTICULO.FORMU = 0 AND Cierre_Inv_protisa.ALMACEN ='" & Trim(CboAlmacen.SelectedValue) & "'  AND FECHA='" & FechaCierre & "'")
        Else
            TmpInsertDatos(" INSERT INTO TMP_KARDEX (CORREL,CODEMPRESA,CDALMA, CDG01, CDARTI, STOCKINI, STOCKREC, COMPRAS, INGAJUSTE, INGTRANSF, INGOTROS,VENTAS, SALAJUSTE, SALTRANSF, SALOTROS ) " &
                             " SELECT '" & rand & "','" & codempresa & "',ALMACEN,ARTICULO.CODLINEA,Cierre_Inv_protisa.ARTICULO,Cierre_Inv_protisa.STOCK AS STKINICIO,0,0,0,0,0,0,0,0,0 " &
                             " FROM Cierre_Inv_protisa,ARTICULO WHERE  ARTICULO.FORMU = 0  AND  Cierre_Inv_protisa.ARTICULO=ARTICULO.CODARTI AND ARTICULO.CODLINEA IN(" & CadenaCateg & ")  AND Cierre_Inv_protisa.ALMACEN ='" & Trim(CboAlmacen.SelectedValue) & "'  AND FECHA='" & Format(FechaCierre, "dd/MM/yyyy") & "'")
        End If
    End Sub
