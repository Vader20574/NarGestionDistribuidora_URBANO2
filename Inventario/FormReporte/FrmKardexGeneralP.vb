Public Class FrmKardexGeneralP
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmKardexGeneralP))
        ...
        'BtnRegresaTodo
        '
        Me.BtnRegresaTodo.Font = New System.Drawing.Font("Microsoft Sans Serif", 15.75!, CType((System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.FontStyle))
        ...
        'BtnRegresaUno
        '
        Me.BtnRegresaUno.Font = New System.Drawing.Font("Microsoft Sans Serif", 15.75!, CType((System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.FontStyle))
        ...
        'BtnPasaTodo
        '
        Me.BtnPasaTodo.Font = New System.Drawing.Font("Microsoft Sans Serif", 15.75!, CType((System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.FontStyle))
        ...
        'BtnPasaUno
        '
        Me.BtnPasaUno.Font = New System.Drawing.Font("Microsoft Sans Serif", 15.75!, CType((System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), System.Drawing.FontStyle), System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Name = "FrmKardexGeneralP"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Reporte Colgate"
...
#End Region
    ...
    Private Sub FrmKardexGeneral_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Tb_Categ1 = TmpListarDatos("SELECT  CODLINEA,DESLINEA  FROM LINEA  WHERE   CODEMPRESA='" & codempresa & "' AND CODLINEA='049'")
...
RegEquiv:
    ...
    Sub Procesar_Saldo(ByVal fechaCierre As String)
        ...
        If CierreIgual = True Then
            ...
            TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_INGSAL_P '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'MOVIDET',0,'" & rand & "'")
            ...
            For i As Integer = 0 To meses
                ...
                If TmpListarDatos("VERIFICA_HISTORICOMOVI '" & codempresa & "','" & MoviC & "'").Rows.Count <> 0 Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_INGSAL_P '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & MoviD & "',1,'" & rand & "'")

                End If
                If VERIFICA_HISTORICOVENT(VentaC) = True Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_SALDO_VENTAS_N_P '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & VentD & "','" & VentaC & "','" & rand & "'")
                End If
            Next
        Else
            ...
            TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_INGSAL_P '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','MOVIDET',0,'" & rand & "'")
            ...
            For i As Integer = 0 To meses
                ...
                If TmpListarDatos("VERIFICA_HISTORICOMOVI '" & codempresa & "','" & MoviC & "'").Rows.Count <> 0 Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_INGSAL_P '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','" & MoviD & "',1,'" & rand & "'")

                End If
                If VERIFICA_HISTORICOVENT(VentaC) = True Then
                    TmpInsertDatos("KARDEX_GENERAL_REPORT_FALTANTES_VENTAS_P '" & codempresa & "','" & Fecinicial & "','" & Fecfinal & "','" & CboAlmacen.SelectedValue.ToString & "','" & CadenaCateg & "'," & Todo_Cate & ",'" & fechaCierre & "','" & VentD & "','" & VentaC & "','" & rand & "'")
                End If
            Next
    ...
    Private Sub INSERTCIERREALDIA(ByVal FechaCierre As Date)
        If Todo_Cate = 1 Then
            TmpInsertDatos("INSERT INTO TMP_KARDEX (CORREL,CODEMPRESA,CDALMA, CDG01, CDARTI, STOCKINI, STOCKREC, COMPRAS, INGAJUSTE, INGTRANSF, INGOTROS,VENTAS, SALAJUSTE, SALTRANSF, SALOTROS )  " &
                          "SELECT '" & rand & "','" & codempresa & "',ALMACEN,ARTICULO.CODLINEA,Cierre_Inv_Gloria.ARTICULO,Cierre_Inv_Gloria.STOCK AS STKINICIO,0,0,0,0,0,0,0,0,0 " &
                          "FROM Cierre_Inv_Gloria,ARTICULO WHERE Cierre_Inv_Gloria.ARTICULO=ARTICULO.CODARTI AND ARTICULO.FORMU = 0 AND Cierre_Inv_Gloria.ALMACEN ='" & Trim(CboAlmacen.SelectedValue) & "'  AND FECHA='" & FechaCierre & "'")
        Else
            TmpInsertDatos(" INSERT INTO TMP_KARDEX (CORREL,CODEMPRESA,CDALMA, CDG01, CDARTI, STOCKINI, STOCKREC, COMPRAS, INGAJUSTE, INGTRANSF, INGOTROS,VENTAS, SALAJUSTE, SALTRANSF, SALOTROS ) " &
                             " SELECT '" & rand & "','" & codempresa & "',ALMACEN,ARTICULO.CODLINEA,Cierre_Inv_Gloria.ARTICULO,Cierre_Inv_Gloria.STOCK AS STKINICIO,0,0,0,0,0,0,0,0,0 " &
                             " FROM Cierre_Inv_Gloria,ARTICULO WHERE  ARTICULO.FORMU = 0  AND  Cierre_Inv_Gloria.ARTICULO=ARTICULO.CODARTI AND ARTICULO.CODLINEA IN(" & CadenaCateg & ")  AND Cierre_Inv_Gloria.ALMACEN ='" & Trim(CboAlmacen.SelectedValue) & "'  AND FECHA='" & Format(FechaCierre, "dd/MM/yyyy") & "'")
        End If
    End Sub
    Private Function SelectFechCiere(ByVal fecha As Date, ByVal HizoCierre As Boolean, ByVal StrAlmacen As String) As DataTable
        ...
        If HizoCierre = True Then
            ...
            dt = TmpListarDatos("select *  from Cierre_Inv_Gloria where fecha=('" & Format(fecha, "dd/MM/yyyy") & "') AND ALMACEN ='" & StrAlmacen & "'")
        Else
            'dt = TmpListarDatos("SELECT max (fechA) AS FECHA from resukdx where fechA <= '" & Format(fecha, "dd/MM/yyyy") & "'  AND ALMACEN ='" & StrAlmacen & "'")
            dt = TmpListarDatos("select max (fechA) AS Fecha from Cierre_Inv_Gloria where fecha <='" & Format(fecha, "dd/MM/yyyy") & "' AND ALMACEN ='" & StrAlmacen & "'")
        ...
        If dt.Rows.Count > 0 Then
            If dt.Rows(0)("Fecha") Is DBNull.Value Then
                ...
                dt = TmpListarDatos("select mIN (fechA)  AS Fecha from Cierre_Inv_Gloria where fechA >='" & Format(fecha, "dd/MM/yyyy") & "' AND ALMACEN ='" & StrAlmacen & "'")
        ...
        Else
            ...
            dt = TmpListarDatos("select max(fecha)  AS Fecha from Cierre_Inv_Gloria where fechA >='" & Format(fecha, "dd/MM/yyyy") & "' AND ALMACEN ='" & StrAlmacen & "' group by articulo ")
