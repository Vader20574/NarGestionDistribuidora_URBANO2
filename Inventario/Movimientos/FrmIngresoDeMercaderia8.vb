Public Class FrmIngresoDeMercaderia8
...
#End Region
    ...
    Private Sub FrmIngresoDeMercaderia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Cargacombos()
        Call BOTONES(False, False, False, False, True)
