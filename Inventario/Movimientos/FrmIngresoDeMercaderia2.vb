Public Class FrmIngresoDeMercaderia2
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmIngresoDeMercaderia2))
        ...
        'ckcosto
        '
        Me.ckcosto.Location = New System.Drawing.Point(454, 112)
        ...
        Me.Name = "FrmIngresoDeMercaderia2"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Ingreso De Mercaderia 2"
...
#End Region
    ...
    Private Sub btnarticulo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnarticulo.Click
        ...
        If TABLEART.Rows.Count > 0 Then
            Dim ConsArticulo As New FrmListarArticuloMercaderia2
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        If MODIFICAR = False Then
            ...
            If TmpListarDatos("NSP_BUSCAR_DOCUMEN_MOVICAB2  '" & codempresa & "','" & cbProveedor.SelectedValue.ToString.Trim & "' ,'" & cbotipo.SelectedValue.ToString.Trim & "','" & (CStr(TxtDoc1.Text) + "-" + TxtDoc2.Text) & "','" & ctipodoc.SelectedValue.ToString.Trim & "','" & rand & "'").Rows.Count > 0 Then
                MsgBox("YA EXISTE ESTE DOCUMENTO REGISTRADO..", MsgBoxStyle.Exclamation, "NAR SISTEMAS S.A.C.")
                Exit Sub
            End If

            If TmpInsertDatos("NSP_GRABAR_MOVIMIENTO_MERCADERIA_ing2  '" & codempresa & "','" & tmovimiento.Text.Trim & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & cbotipo.SelectedValue.ToString.Trim & "','" & cbProveedor.SelectedValue.ToString.Trim & "','" & ctipodoc.SelectedValue.ToString.Trim & "','" & 1 & "','" & (CStr(TxtDoc1.Text) + TxtDoc2.Text) & "' ,'" & Format(dtpfecha.Value, "dd/MM/yyyy") & "','" & CboMoneda.SelectedValue.ToString.Trim & "','" & LblSubtotal.Text & "','" & Format(CDbl(LblSubtotal.Text) / VCambioCompra, "#######0.00") & "','" & VCambioCompra & "','" & LblIGV.Text & "','" & Format(CDbl(LblIGV.Text) / VCambioCompra, "#######0.00") & "','" & LblTotal.Text & "','" & Format(CDbl(LblTotal.Text) / VCambioCompra, "#######0.00") & "', '" & TxtDesc.Text.Trim & "','" & Format((CDbl(LblValorVenta.Text) - CDbl(LblSubtotal.Text)), "#######0.00") & "','" & Format(((CDbl(LblValorVenta.Text) - CDbl(LblSubtotal.Text)) / VCambioCompra), "#######0.00") & "' ,'" & cbAlmacen.SelectedValue.ToString.Trim & "','" & CodUsuario & "','" & cboPeriodo.Text & "','" & txtEjercicio.Text.Trim & "','" & OBS & "','" & cbAlmacen.SelectedValue.ToString.Trim & "' ,'" & CRED & "','" & CboFormaPago.SelectedValue.ToString.Trim & "','" & NROPTOVTA & "','" & CDbl(txtFlete.Text) & "','" & CORREL & "' ,'" & IIf(TRANS = True, 1, 0) & "','" & CDbl(TxtPercep.Text) & "','" & CDbl(TxtDetrac.Text) & "','" & dtpfechaRecepcion.Value.ToShortDateString & "','" & 1 & "','" & Txt_FormaPago.Text & "','" & txtGlosa.Text & "','" & txtAlmacen.Text & "','" & costo & "'") = True Then
                If cbProveedor.Enabled = True Then
                    If CboFormaPago.Visible = True Then

                        ''CASO Q SEA INGRESO X COMPRA
                        'If cbotipo.SelectedValue.ToString.Trim = VCODINGCOMP.Trim Then
                        '    If ctipodoc.SelectedValue.ToString.Trim = CDNTACREDP Then ' cambia esos valores de q es ? TIENE Q SER FIJO

                        '        CAyuda.Ejecutar("Ins_COMPRA_X_PAGARxProc", codempresa, ctipodoc.SelectedValue, (CStr(TxtDoc1.Text) + TxtDoc2.Text), CboMoneda.SelectedValue, cbProveedor.SelectedValue, -CDbl(LblTotal.Text), -CDbl(LblTotal.Text) / VCambioCompra, Format(dtpfecha.Value, "dd/MM/yyyy"), CboFormaPago.SelectedValue, "", CodUsuario, CDbl(TxtPercep.Text), txtGlosa.Text, Txt_FormaPago.Text, txtAlmacen.Text)
                        '    Else
                        '        CAyuda.Ejecutar("Ins_COMPRA_X_PAGARxProc", codempresa, ctipodoc.SelectedValue, (CStr(TxtDoc1.Text) + TxtDoc2.Text), CboMoneda.SelectedValue, cbProveedor.SelectedValue, CDbl(LblTotal.Text), CDbl(LblTotal.Text) / VCambioCompra, Format(dtpfecha.Value, "dd/MM/yyyy"), CboFormaPago.SelectedValue, "", CodUsuario, CDbl(TxtPercep.Text), txtGlosa.Text, Txt_FormaPago.Text, txtAlmacen.Text)
        ...
        Else
            ...
            If (CStr(TxtDoc1.Text) + TxtDoc2.Text) = NRODOC_ANT.Trim And ctipodoc.SelectedValue.ToString.Trim = TIPODOC_ANT.Trim Then
            Else
            ...
            If TmpInsertDatos("NSP_MODIFICA_MOVIMIENTO_MERCADERIA_ingr2  '" & codempresa & "','" & tmovimiento.Text.Trim & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & cbotipo.SelectedValue.ToString.Trim & "','" & cbProveedor.SelectedValue.ToString.Trim & "','" & ctipodoc.SelectedValue.ToString.Trim & "','" & 1 & "','" & (CStr(TxtDoc1.Text) + TxtDoc2.Text) & "' ,'" & Format(dtpfecha.Value, "dd/MM/yyyy") & "','" & CboMoneda.SelectedValue.ToString.Trim & "','" & LblSubtotal.Text & "','" & Format(CDbl(LblSubtotal.Text) / VCambioCompra, "#######0.00") & "','" & VCambioCompra & "','" & LblIGV.Text & "','" & Format(CDbl(LblIGV.Text) / VCambioCompra, "#######0.00") & "','" & LblTotal.Text & "','" & Format(CDbl(LblTotal.Text) / VCambioCompra, "#######0.00") & "', '" & TxtDesc.Text.Trim & "','" & Format((CDbl(LblValorVenta.Text) - CDbl(LblSubtotal.Text)), "#######0.00") & "','" & Format(((CDbl(LblValorVenta.Text) - CDbl(LblSubtotal.Text)) / VCambioCompra), "#######0.00") & "' ,'" & cbAlmacen.SelectedValue.ToString.Trim & "','" & CodUsuario & "','" & cboPeriodo.Text & "','" & txtEjercicio.Text.Trim & "','" & OBS & "','" & cbAlmacen.SelectedValue.ToString.Trim & "' ,'" & CRED & "','" & CboFormaPago.SelectedValue.ToString.Trim & "','" & NROPTOVTA & "','" & CDbl(txtFlete.Text) & "','" & CORREL & "' ,'" & IIf(TRANS = True, 1, 0) & "','" & CDbl(TxtPercep.Text) & "','" & CDbl(TxtDetrac.Text) & "','" & Me.dtpfechaRecepcion.Value.ToShortDateString & "','" & MoviCab & "','" & MoviDet & "','" & Txt_FormaPago.Text & "','" & txtGlosa.Text & "','" & txtAlmacen.Text & "','" & costo & "'") = True Then
                'TmpInsertDatos("NSP_INS_OBS_TRANS_MERC  '" & codempresa & "','" & tmovimiento.Text.Trim & "','" & cbotipo.SelectedValue.ToString & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & 1 & "','" & AUTORIZANTE & "','" & RESPONSABLE & "','" & DATOTRANS & "'")
                ...
                'If cbotipo.SelectedValue.ToString.Trim = VCODINGCOMP.Trim Then
                '    If ctipodoc.SelectedValue.ToString.Trim = CDNTACREDP Then ' cambia esos valores de q es ? TIENE Q SER FIJO
                '        CAyuda.Ejecutar("Upd_COMPRA_X_PAGARxProc", codempresa, ctipodoc.SelectedValue, (CStr(TxtDoc1.Text) + TxtDoc2.Text), CboMoneda.SelectedValue, cbProveedor.SelectedValue, -CDbl(LblTotal.Text), -CDbl(LblTotal.Text) / VCambioCompra, Format(dtpfecha.Value, "dd/MM/yyyy"), CboFormaPago.SelectedValue, "", CodUsuario, CDbl(TxtPercep.Text), txtGlosa.Text, Txt_FormaPago.Text, txtAlmacen.Text, NRODOC_ANT, TIPODOC_ANT)
                '    Else
                '        CAyuda.Ejecutar("Upd_COMPRA_X_PAGARxProc", codempresa, ctipodoc.SelectedValue, (CStr(TxtDoc1.Text) + TxtDoc2.Text), CboMoneda.SelectedValue, cbProveedor.SelectedValue, CDbl(LblTotal.Text), CDbl(LblTotal.Text) / VCambioCompra, Format(dtpfecha.Value, "dd/MM/yyyy"), CboFormaPago.SelectedValue, "", CodUsuario, CDbl(TxtPercep.Text), txtGlosa.Text, Txt_FormaPago.Text, txtAlmacen.Text, NRODOC_ANT, TIPODOC_ANT)
                '    End If
                'End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBusMovi.Click
        ...
        Try
            ...
            Dim FRMBUSC As New FrmConsultarMovimientoMercaderia2
            FRMBUSC.INOUT = 1
            FRMBUSC.ShowDialog()
            ...
            TABLE1 = TmpListarDatos("SP_SEL_MOVICAB2  '" & tmovimiento.Text & "','" & 1 & "','" & MoviCab & "'")
            ...
            TABLE_CAB_M = TmpListarDatos("NSP_TRAER_MOVIMIENTO_MERC_M1_2  '" & codempresa & "','" & tmovimiento.Text & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & IIf(IsNothing(cbotipo.SelectedValue), "", cbotipo.SelectedValue) & "','" & 1 & "','" & rand & "','" & MoviDet & "'")
            TABLE_CAB = TmpListarDatos("NSP_TRAER_MOVIMIENTO_MERC2  '" & codempresa & "','" & tmovimiento.Text & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & IIf(IsNothing(cbotipo.SelectedValue), "", cbotipo.SelectedValue) & "','" & 1 & "','" & CORREL & "','" & MoviCab & "','" & MoviDet & "'")
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If TmpInsertDatos("NSP_ANULAR_INGRESO_MERCADERIA_2  '" & tmovimiento.Text.Trim & "','" & cbotipo.SelectedValue.ToString.Trim & "','" & (CStr(TxtDoc1.Text) & TxtDoc2.Text.Trim) & "','" & ctipodoc.SelectedValue.ToString.Trim & "','" & codempresa & "','" & MoviCab & "','" & MoviDet & "'") = True Then
    ...
    Private Sub BTNREPORTE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNREPORTE.Click
        ...
        With axcrt2
            ...
            .ReportFileName = rutareporte + CType("Rpt_Ingreso_Inventario2.rpt", String)
