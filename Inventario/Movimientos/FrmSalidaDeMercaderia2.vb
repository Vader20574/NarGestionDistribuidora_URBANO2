Public Class FrmSalidaDeMercaderia2
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmSalidaDeMercaderia2))
        ...
        '
        'FrmSalidaDeMercaderia2
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(1260, 741)
        ...
        Me.Name = "FrmSalidaDeMercaderia2"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Salida De Mercaderia 2"
...
#Region "FUNCIONES"
    ...
    Private Sub Cargacombos()
        ...
        CAyuda.CargarDataCombo(cbotipo, "SelecTIPOMOVIxUserId '" & codempresa & "','" & CodUsuario & "','0' ", "Código", "Descripción")
        ...
        'CAyuda.CargarDataCombo(ctipodoc, "nsp_sele_tipodoc '" & CodEmpresa & "'", "Codigo", "Descripcion")
        'CAyuda.CargarDataCombo(cbotipo, "Nsp_Sele_tipomovisal '" & CodEmpresa & "'", "Código", "Descripción")
...
#End Region
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        Else
            ...
            Else
                ...
                dtpfecha.Focus()
                If TmpListarDatos("NSP_BUSCAR_DOCUMEN_MOVICAB2  '" & codempresa & "','" & cbProveedor.SelectedValue.ToString.Trim & "' ,'" & cbotipo.SelectedValue.ToString.Trim & "','" & (CStr(CInt(TxtDoc1.Text)) + TxtDoc2.Text) & "','" & ctipodoc.SelectedValue.ToString.Trim & "','" & rand & "'").Rows.Count > 0 Then
                    MsgBox("YA EXISTE ESTE DOCUMENTO REGISTRADO..", MsgBoxStyle.Exclamation, "NAR SISTEMAS S.A.C.")
                    Exit Sub
                End If
            End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBusMovi.Click
        ...
        Dim FRMBUSC As New FrmConsultarMovimientoMercaderia3
        FRMBUSC.INOUT = 0
        FRMBUSC.ShowDialog()
        ...
        TABLE_CAB_M = TmpListarDatos("NSP_TRAER_MOVIMIENTO_MERC_M2  '" & codempresa & "','" & tmovimiento.Text & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & IIf(IsNothing(cbotipo.SelectedValue), "", cbotipo.SelectedValue) & "','" & 0 & "','" & rand & "','" & MoviDet & "'")

        TABLE_CAB = TmpListarDatos("NSP_TRAER_MOVIMIENTO_MERC2  '" & codempresa & "','" & tmovimiento.Text & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & IIf(IsNothing(cbotipo.SelectedValue), "", cbotipo.SelectedValue) & "','" & 0 & "','" & CORREL & "','" & MoviCab & "','" & MoviDet & "'")
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If TmpInsertDatos("NSP_ANULAR_INGRESO_MERCADERIA2  '" & tmovimiento.Text.Trim & "','" & cbotipo.SelectedValue.ToString.Trim & "','" & (CStr(TxtDoc1.Text) & TxtDoc2.Text.Trim) & "','" & ctipodoc.SelectedValue.ToString.Trim & "','" & codempresa & "','" & MoviCab & "','" & MoviDet & "'") = True Then
    ...
    Private Sub BTNREPORTE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNREPORTE.Click
        ...
        With axcrt2
            ...
            .ReportFileName = rutareporte + CType("rpt_Salida_Inventario2.rpt", String)
