...
Public Class FrmListarArticuloProduccion2
...
#Region "Variables"
    ...
    Public Ingreso As New FrmTrasladoProduccion
...
#End Region
    ...
    Private Sub Devuelve()
        Try
            ...
            Ingreso.tarticuloP.Text = Trim(GridArt.Item(GridArt.CurrentRowIndex, 0))
            Ingreso.txtdesarticuloP.Text = Trim(GridArt.Item(GridArt.CurrentRowIndex, 1))

            'Ingreso.Label16.Visible = False
            'Ingreso.txtcantidadD.Visible = False
            Ingreso.txtcantidadP.ReadOnly = False
