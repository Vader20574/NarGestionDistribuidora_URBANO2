Public Class FrmTrasladoDeMercaderia
...
#Region "FUNCIONES"
    ...
    Private Sub Cargacombos()
        ...
        CAyuda.CargarDataCombo(cbotipo, "SelecTIPOMOVIxUserId '" & codempresa & "','" & CodUsuario & "','2' ", "Código", "Descripción")
...
#End Region
    ...
    Sub Procesar_Saldo(ByVal fechaCierre As String, ByVal CDALMACEN As String)
        ...
        Else
            ...
            'MstrFechaIni = "14/12/2015"
            'MstrFechaFin = "15/12/2015"
            ...
            ' meses = Val(DateDiff("m", "14/12/2015", "15/12/2015"))
    ...
    Private Sub INSERTCIERREALDIA(ByVal FechaCierre As Date, ByVal ALMACEN As String)
        ...
        Else
            TmpInsertDatos(" INSERT INTO TMP_KARDEX (CORREL,CODEMPRESA,CDALMA, CDG01, CDARTI, STOCKINI, STOCKREC, COMPRAS, INGAJUSTE, INGTRANSF, INGOTROS,VENTAS, SALAJUSTE, SALTRANSF, SALOTROS ) " &
                             " SELECT '" & rand & "','" & codempresa & "',ALMACEN,ARTICULO.CODLINEA,CIERRE_MES_INVENTARIO.ARTICULO,CIERRE_MES_INVENTARIO.STOCK AS STKINICIO,0,0,0,0,0,0,0,0,0 " &
                             " FROM CIERRE_MES_INVENTARIO,ARTICULO WHERE  ARTICULO.FORMU = 0  AND  CIERRE_MES_INVENTARIO.ARTICULO=ARTICULO.CODARTI AND ARTICULO.CODARTI IN(" & CadenaCateg & ")  AND CIERRE_MES_INVENTARIO.ALMACEN ='" & Trim(ALMACEN) & "'  AND FECHA='" & Format(FechaCierre, "dd/MM/yyyy") & "'")
        End If
    End Sub
