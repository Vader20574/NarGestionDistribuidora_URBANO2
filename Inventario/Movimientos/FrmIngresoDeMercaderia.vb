Public Class FrmIngresoDeMercaderia
...
#End Region
    ...
    Private Sub btnarticulo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnarticulo.Click
        ...
        If TABLEART.Rows.Count > 0 Then
            Dim ConsArticulo As New FrmListarArticuloMercaderia
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnBusMovi.Click
        ...
        Try
            ...
            TABLE1 = TmpListarDatos("SP_SEL_MOVICAB  '" & tmovimiento.Text & "','" & 1 & "','" & MoviCab & "'")
            ...
            TABLE_CAB_M = TmpListarDatos("NSP_TRAER_MOVIMIENTO_MERC_M1  '" & codempresa & "','" & tmovimiento.Text & "','" & cbAlmacen.SelectedValue.ToString.Trim & "','" & IIf(IsNothing(cbotipo.SelectedValue), "", cbotipo.SelectedValue) & "','" & 1 & "','" & rand & "','" & MoviDet & "'")
