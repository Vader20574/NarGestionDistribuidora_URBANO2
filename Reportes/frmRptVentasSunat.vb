Public Class frmRptVentasSunat
    Dim rand As Integer
        ...
        For i As Integer = 0 To nromeses
            ...
            If CAyuda.ListarDatos("VERIFICA_HISTORICOVENT", NomTablaC, codempresa).Tables(0).Rows.Count > 0 Then
                If CheckBox1.Checked = True Then
                    CAyuda.Ejecutar("SP_RPT_VTA_SUNA_BM", codempresa, fechaini, fechahas, cmbvendedor.SelectedValue.ToString(), Trim(cadena), PORCIGV, VCdPagCredito, rand, NomTablaC, NomTablaD, 1)
                Else
                    CAyuda.Ejecutar("SP_RPT_VTA_SUNA", codempresa, fechaini, fechahas, cmbvendedor.SelectedValue.ToString(), Trim(cadena), PORCIGV, VCdPagCredito, rand, NomTablaC, NomTablaD, 1)
                End If
            End If
        Next

        If CheckBox1.Checked = True Then
            CAyuda.Ejecutar("SP_RPT_VTA_SUNA_BM", codempresa, fechaini, fechahas, cmbvendedor.SelectedValue.ToString(), Trim(cadena), PORCIGV, VCdPagCredito, rand, "VENTACAB", "VENTADET", 0)
        Else
            CAyuda.Ejecutar("SP_RPT_VTA_SUNA", codempresa, fechaini, fechahas, cmbvendedor.SelectedValue.ToString(), Trim(cadena), PORCIGV, VCdPagCredito, rand, "VENTACAB", "VENTADET", 0)
        End If

        Try
            With AxCrystalReport1
                .ReportFileName = RutaRptInv & "Rpt_Venta_Sunat.rpt"
