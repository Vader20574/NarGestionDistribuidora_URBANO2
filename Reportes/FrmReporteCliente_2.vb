Public Class FrmReporteCliente_2
    ...
    Private Sub btnReporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReporte.Click
        ...
        If rbRuta.Checked = True Then
            Sql = "NSP_INSERT_TMP_DISTRITO1 '" & codempresa & "','','" & rand & "'"
            If TmpInsertDatos(Sql) = True Then
            End If
        ...
        If rbDistrito.Checked = True Then
            Sql = "NSP_INSERT_TMP_RUTA1 '" & codempresa & "',''"
            If TmpInsertDatos(Sql) = True Then
            End If

            For i As Integer = 0 To Tb_DistritoModSelec.Rows.Count - 1
                Sql = "NSP_INSERT_TMP_DISTRITO '" & codempresa & "','" & Tb_DistritoModSelec.Rows(i)("Codigo").ToString.Trim & "','" & rand & "'"
                If TmpInsertDatos(Sql) = True Then
                End If
            Next
