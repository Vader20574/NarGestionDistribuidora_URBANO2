Public Class RptAnalisisCobro2
    ...
    Private Sub txtNroDoc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNroDoc.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            Try
                Dim TablaTemp As New DataTable
                TablaTemp = CAyuda.ListarDatos("NSP_TRAER_CLIENTE_VTA_COBRAR_DOC", Me.cbTipoDoc.SelectedValue.ToString.Trim, txtNroDoc.Text.Trim).Tables(0)


                If TablaTemp.Rows.Count > 0 Then

                    If TablaTemp.Rows(0)("ESTADO2") = "A" Then
    ...
    Private Sub CargarGridDet()
        ...
        TAB_DETALLE = TmpListarDatos("NSP_ANALISIS_COBRO_DOC '" & codempresa & "','" & cbTipoDoc.SelectedValue & "','" & txtNroDoc.Text & "','" & rand & "'")
