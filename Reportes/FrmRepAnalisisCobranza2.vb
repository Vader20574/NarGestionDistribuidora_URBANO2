Public Class FrmRepAnalisisCobranza2
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Sql = "DELETE  FROM TMP_IMPORTE_PLANDIAS "
        If TmpInsertDatos(Sql) = True Then
        End If

        Sql = "SP_INSERT_IMPORTE_PLANDIAS '" & rand & "','" & txtdias.Text & "',''"
        If TmpInsertDatos(Sql) = True Then
        End If
        ...
        For i As Integer = 0 To meses
            ...
            If VERIFICA_HISTORICOVENT(VentaC) = True Then
                Sql = "SP_INSERT_IMPORTE_PLANDIAS '" & rand & "','" & txtdias.Text & "','" & VentaC & "'"
                If TmpInsertDatos(Sql) = True Then
                End If
            End If
        Next
        ...
        Try
            ...
            crRpt.ReportFileName = rutareporte & "Reporte_Analisis_Cobro2.rpt"
            ...
            crRpt.set_StoredProcParam(1, txtdias.Text)
