...
Public Class Frm_Ventas_Productos
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        RptaTrans = CAyuda.Ejecutar("UPDATE_TMP_RPT_VENT_PRODUCT_1", RAN, TextBox1.Text, TextBox2.Text, TextBox3.Text, TextBox4.Text, CDbl(TextBox5.Text), CDbl(TextBox6.Text))
        If RptaTrans Then
        ...
        TablaCuotasLinea = CAyuda.ListarDatos("SP_SELECT_VENT_PRODUCT_1", RAN).Tables(0)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Reporte("Reporte_Venta_Todo_1.rpt")
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        TmpInsertDatos("DELETE FROM TMP_RPT_VENT_PRODUCT_1  WHERE CORREL='" & RAN & "'")
        ...
        If OpenFileDialog1.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            ...
            Try
                ...
                For a As Integer = 0 To excel.Length - 1
                    ...
                    'o.CANTIDAD = IIf(Decimal.TryParse(linea(5), precio) = True, precio, 0)
                    'o.TOTAL = IIf(Decimal.TryParse(linea(6), precio) = True, precio, 0)
                    ...
                    Dim RptaTrans As Boolean
                    RptaTrans = CAyuda.Ejecutar("UPDATE_TMP_RPT_VENT_PRODUCT_1", linea(0), linea(1), linea(2), linea(3), linea(4), CDbl(linea(5)), CDbl(linea(6)))
                    If RptaTrans Then
