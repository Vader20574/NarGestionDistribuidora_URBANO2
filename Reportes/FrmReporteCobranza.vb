...
Public Class FrmReporteCobranza
    ...
    Private Sub CargarGridDet()
        ...
        '            TmpInsertDatos("SP_INSERT_COBRANZA  '" & codempresa & "','" & dtpinicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtpfin.Value.ToString("dd/MM/yyyy") & "','" & comboRuta.SelectedValue & "','" & rand & "','" & NomTablaC & "'")

        '        Else
        '            TmpInsertDatos("SP_INSERT_COBRANZA2  '" & codempresa & "','" & dtpinicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtpfin.Value.ToString("dd/MM/yyyy") & "','" & comboRuta.SelectedValue & "','" & rand & "','" & NomTablaC & "'")
        ...
        If CheckBox2.Checked = False Then
            TmpInsertDatos("SP_INSERT_COBRANZA  '" & codempresa & "','" & dtpinicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtpfin.Value.ToString("dd/MM/yyyy") & "','" & comboRuta.SelectedValue & "','" & rand & "',''")
        Else
            TmpInsertDatos("SP_INSERT_COBRANZA2  '" & codempresa & "','" & dtpinicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtpfin.Value.ToString("dd/MM/yyyy") & "','" & comboRuta.SelectedValue & "','" & rand & "',''")
        End If
        ...
        'If CheckBox2.Checked = False Then
        '    TAB_DETALLE = TmpListarDatos("SP_INSERT_COBRANZA '" & codempresa & "','" & dtpinicio.Value.ToString("dd/MM/yyyy") & "','" & Me.dtpfin.Value.ToString("dd/MM/yyyy") & "','" & comboRuta.SelectedValue & "','" & rand & "'")
        '    dgDetalleCobranza.DataSource = TAB_DETALLE
        'Else
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If CheckBox5.Checked = True Then
            ...
            Try
                With AxCrystalReport1
                    .ReportFileName = RutaRptInv & "Rpt_CobranzaCodificado.rpt"
        ...
        Try
            With AxCrystalReport1
                ...
                ' MsgBox(Len(strconsul))


                If CheckBox1.Checked = False Then
                    If Len(strconsul) > 235 Then
                        MsgBox("HA SELECCIONADO MUCHOS VENDEDORES SI QUIERE Q APAREZCAN TODO SELECCIONE CHECK DE ARRIBA TODO LOS VENDEDORES ")
                        Exit Sub
                    End If
                End If
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        sql = "NSP_INSERT_TMP_VTAPROM4 '" & codempresa & "','" & TAB_DETALLE.Rows(0)(0).ToString & "'"
        If TmpInsertDatos(sql) = True Then
        End If

        sql = "NSP_INSERT_TMP_VTASUMTOTBAS '" & codempresa & "','" & TAB_DETALLE.Rows(0)(0).ToString & "'"
        If TmpInsertDatos(sql) = True Then
        End If

        sql = "NSP_INSERT_TMP_VTASUMPORCE '" & codempresa & "','" & TAB_DETALLE.Rows(0)(0).ToString & "'"
        If TmpInsertDatos(sql) = True Then
        End If
