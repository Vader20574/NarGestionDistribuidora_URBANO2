...
Public Class frmRptVentas3
    ...
    Private Sub frmRptVentas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dt = CAyuda.ListarDatos("SP_ListVendedor1", codempresa).Tables(0)
        ListaV = LLenar(dt)
    ...
    Private Sub btnmostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnmostrar.Click
        ...
        CAyuda.Ejecutar("SP_RPT_VENT_EX", rand, codempresa, fechaini.ToShortDateString, fechahas.ToShortDateString, "", "", 0)
        ...
        TmpInsertDatos("DELETE FROM TMP_IPERCEP WHERE CORREL='" + rand.ToString + "'")
        For i = 0 To nromeses
            ...
            If CAyuda.ListarDatos("VERIFICA_HISTORICOVENT", NomTablaC, codempresa).Tables(0).Rows.Count > 0 Then
                CAyuda.Ejecutar("SP_INSERT_TMP_IPERCEP", rand, codempresa, fechaini.ToShortDateString, fechahas.ToShortDateString, NomTablaD, NomTablaC, 1)
            End If
        Next

        CAyuda.Ejecutar("SP_INSERT_TMP_IPERCEP", rand, codempresa, fechaini.ToShortDateString, fechahas.ToShortDateString, "", "", 0)
        ...
        Dim total As Double
        Dim ipercep As Double
        Dim dtrpt1 As New DataTable
        dtrpt1 = CAyuda.ListarDatos("SP_RPT_SELECT_VENTAS_EX_SUM", rand, codempresa, Me.cmbfuerza.SelectedValue.ToString, Me.cmbruta.SelectedValue.ToString, fechaini, fechahas).Tables(0)
        total = dtrpt1.Rows(0)(0).ToString


        Dim dtipercep As New DataTable
        dtipercep = CAyuda.ListarDatos("SP_SUM_IPERCEP", rand).Tables(0)
        ipercep = dtipercep.Rows(0)(0).ToString

        Label5.Text = Format(CDbl((total + ipercep)), "#######0.00")
    End Sub
