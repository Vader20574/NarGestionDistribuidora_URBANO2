Public Class RptAnalisisPlanilla2
    ...
    Private Sub RptAnalisisCobro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dt = CAyuda.ListarDatos("LISTAR_PLANILLAS").Tables(0)
        ListaV = LLenar(dt)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        For k As Integer = 0 To ListaV2.Count - 1
            ...
            SQL = "INSERT_TMP_TIPO_PLANILLAS '" & ListaV2.Item(k).DESCRIPCION.ToString & "'"
            If TmpInsertDatos(Sql) = True Then
            End If
        Next
        ...
        TAB_DETALLE = TmpListarDatos("NSP_ANALISIS_PLANILLA2 '" & codempresa & "','" & rand & "','" & fechaini & "','" & fechahas & "'")
    ...
    Sub Reporte()
        ...
        TAB_DETALLE2 = TmpListarDatos("SELECT_TOTAL_DIARO '" & rand & "'")
        TOTAL = CDbl(TAB_DETALLE2.Rows(0)(0).ToString)
        CONTADO = CDbl(TAB_DETALLE2.Rows(0)(1).ToString)
        CREDITO = CDbl(TAB_DETALLE2.Rows(0)(2).ToString)

        Try
            With AxCrystalReport1
                .ReportFileName = RutaRptInv & "Rpt_Diario_Tienda.rpt"
                .Connect = "DSN=reportes;UID=" & usuariodb & ";PWD=" & Trim(passworddb) & ";"
                .set_Formulas(0, "Empresa='" & TOTAL.ToString & "'")
                .set_Formulas(1, "Usuario='" & CONTADO.ToString & "'")
                .set_Formulas(2, "EMP='" & CREDITO.ToString & "'")
